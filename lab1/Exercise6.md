...
```
As a result, we can temporarily regard this part as something fixed in hardware programming and the point of this chunk of code is to get the sections loaded. 
