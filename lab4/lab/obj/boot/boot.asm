...
bootmain(void)
{
    ...
    7d2b:	45 4c 46 
    7d2e:	75 53                	jne    7d83 <bootmain+0x78>
		goto bad;
	...
	for (; ph < eph; ph++) {
    7d49:	eb 2e                	jmp    7d79 <bootmain+0x6e>
    ...
    7d5e:	eb 0a                	jmp    7d6a <bootmain+0x5f>
			*((char *) ph->p_pa + ph->p_filesz + i) = 0;
    7d60:	8d 14 08             	lea    (%eax,%ecx,1),%edx
    7d63:	03 53 0c             	add    0xc(%ebx),%edx
    7d66:	c6 02 00             	movb   $0x0,(%edx)
	eph = ph + ELFHDR->e_phnum;
	for (; ph < eph; ph++) {
		// p_pa is the load address of this segment (as well
		// as the physical address)
		...
		for (i = 0; i < ph->p_memsz - ph->p_filesz; i++) {
    7d69:	40                   	inc    %eax
    7d6a:	8b 4b 10             	mov    0x10(%ebx),%ecx
    7d6d:	8b 53 14             	mov    0x14(%ebx),%edx
    7d70:	29 ca                	sub    %ecx,%edx
    7d72:	39 d0                	cmp    %edx,%eax
    7d74:	72 ea                	jb     7d60 <bootmain+0x55>
		goto bad;
	...
	eph = ph + ELFHDR->e_phnum;
	for (; ph < eph; ph++) {
    7d76:	83 c3 20             	add    $0x20,%ebx
    7d79:	39 f3                	cmp    %esi,%ebx
    7d7b:	72 ce                	jb     7d4b <bootmain+0x40>
		}
	}
...
outw(int port, uint16_t data)
{
    ...
    7d83:	ba 00 8a 00 00       	mov    $0x8a00,%edx
    7d88:	b8 00 8a ff ff       	mov    $0xffff8a00,%eax
    7d8d:	66 ef                	out    %ax,(%dx)
    7d8f:	b8 00 8e ff ff       	mov    $0xffff8e00,%eax
    7d94:	66 ef                	out    %ax,(%dx)
    7d96:	eb fe                	jmp    7d96 <bootmain+0x8b>
