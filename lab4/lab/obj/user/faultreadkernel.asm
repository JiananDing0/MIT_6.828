	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80022d:	0f be 80 11 10 80 00 	movsbl 0x801011(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800348:	ff 24 95 e0 10 80 00 	jmp    *0x8010e0(,%edx,4)
  ...
  800408:	c7 44 24 08 32 10 80 	movl   $0x801032,0x8(%esp)
  80040f:	00 
  ...
  80043c:	75 05                	jne    800443 <vprintfmt+0x185>
				p = "(null)";
  80043e:	be 22 10 80 00       	mov    $0x801022,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800ab6:	00 
  800ab7:	c7 44 24 08 64 12 80 	movl   $0x801264,0x8(%esp)
  800abe:	00 
  800abf:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ac6:	00 
  800ac7:	c7 04 24 81 12 80 00 	movl   $0x801281,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b48:	00 
  800b49:	c7 44 24 08 64 12 80 	movl   $0x801264,0x8(%esp)
  800b50:	00 
  800b51:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b58:	00 
  800b59:	c7 04 24 81 12 80 00 	movl   $0x801281,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b9b:	00 
  800b9c:	c7 44 24 08 64 12 80 	movl   $0x801264,0x8(%esp)
  800ba3:	00 
  800ba4:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bab:	00 
  800bac:	c7 04 24 81 12 80 00 	movl   $0x801281,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bee:	00 
  800bef:	c7 44 24 08 64 12 80 	movl   $0x801264,0x8(%esp)
  800bf6:	00 
  800bf7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bfe:	00 
  800bff:	c7 04 24 81 12 80 00 	movl   $0x801281,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c41:	00 
  800c42:	c7 44 24 08 64 12 80 	movl   $0x801264,0x8(%esp)
  800c49:	00 
  800c4a:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c51:	00 
  800c52:	c7 04 24 81 12 80 00 	movl   $0x801281,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c94:	00 
  800c95:	c7 44 24 08 64 12 80 	movl   $0x801264,0x8(%esp)
  800c9c:	00 
  800c9d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ca4:	00 
  800ca5:	c7 04 24 81 12 80 00 	movl   $0x801281,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800d09:	00 
  800d0a:	c7 44 24 08 64 12 80 	movl   $0x801264,0x8(%esp)
  800d11:	00 
  800d12:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d19:	00 
  800d1a:	c7 04 24 81 12 80 00 	movl   $0x801281,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d5c:	c7 04 24 90 12 80 00 	movl   $0x801290,(%esp)
  ...
  800d72:	e8 84 f3 ff ff       	call   8000fb <vcprintf>
	cprintf("\n");
  800d77:	c7 04 24 b4 12 80 00 	movl   $0x8012b4,(%esp)
