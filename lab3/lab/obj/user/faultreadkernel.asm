	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800225:	0f be 80 ad 0d 80 00 	movsbl 0x800dad(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800340:	ff 24 95 3c 0e 80 00 	jmp    *0x800e3c(,%edx,4)
  ...
  800400:	c7 44 24 08 ce 0d 80 	movl   $0x800dce,0x8(%esp)
  800407:	00 
  ...
  800434:	75 05                	jne    80043b <vprintfmt+0x185>
				p = "(null)";
  800436:	be be 0d 80 00       	mov    $0x800dbe,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800a8e:	00 
  800a8f:	c7 44 24 08 b0 0f 80 	movl   $0x800fb0,0x8(%esp)
  800a96:	00 
  800a97:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800a9e:	00 
  800a9f:	c7 04 24 cd 0f 80 00 	movl   $0x800fcd,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800adf:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  ...
  800b00:	c7 04 24 dc 0f 80 00 	movl   $0x800fdc,(%esp)
  ...
  800b16:	e8 d8 f5 ff ff       	call   8000f3 <vcprintf>
	cprintf("\n");
  800b1b:	c7 04 24 00 10 80 00 	movl   $0x801000,(%esp)
