...
libmain(int argc, char **argv)
{
  ...
  80004a:	e8 dc 00 00 00       	call   80012b <sys_getenvid>
	thisenv = &envs[ENVX(envid)];
  80004f:	25 ff 03 00 00       	and    $0x3ff,%eax
  800054:	8d 04 40             	lea    (%eax,%eax,2),%eax
  800057:	c1 e0 05             	shl    $0x5,%eax
  80005a:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  80005f:	a3 04 10 80 00       	mov    %eax,0x801004

	// save the name of the program so that panic() can use it
	if (argc > 0)
  800064:	85 f6                	test   %esi,%esi
  800066:	7e 07                	jle    80006f <libmain+0x33>
		binaryname = argv[0];
  800068:	8b 03                	mov    (%ebx),%eax
  80006a:	a3 00 10 80 00       	mov    %eax,0x801000

	// call user main routine
	umain(argc, argv);
  80006f:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800073:	89 34 24             	mov    %esi,(%esp)
