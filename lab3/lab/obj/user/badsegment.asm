...
libmain(int argc, char **argv)
{
  ...
  80004e:	e8 dc 00 00 00       	call   80012f <sys_getenvid>
  ...
  800063:	a3 04 10 80 00       	mov    %eax,0x801004
  ...
  80006e:	a3 00 10 80 00       	mov    %eax,0x801000
  ...
  80007a:	e8 b5 ff ff ff       	call   800034 <umain>
	...
	// exit gracefully
	exit();
  80007f:	e8 08 00 00 00       	call   80008c <exit>
}
...
sys_env_destroy(envid_t envid)
{
  ...
  80010a:	00 
  80010b:	c7 44 24 08 72 0d 80 	movl   $0x800d72,0x8(%esp)
  800112:	00 
  800113:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  80011a:	00 
  80011b:	c7 04 24 8f 0d 80 00 	movl   $0x800d8f,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80015b:	8b 1d 00 10 80 00    	mov    0x801000,%ebx
  ...
  80017c:	c7 04 24 a0 0d 80 00 	movl   $0x800da0,(%esp)
  ...
  800192:	e8 50 00 00 00       	call   8001e7 <vcprintf>
	cprintf("\n");
  800197:	c7 04 24 c4 0d 80 00 	movl   $0x800dc4,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800319:	0f be 80 c6 0d 80 00 	movsbl 0x800dc6(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800434:	ff 24 95 54 0e 80 00 	jmp    *0x800e54(,%edx,4)
  ...
  8004f4:	c7 44 24 08 e7 0d 80 	movl   $0x800de7,0x8(%esp)
  8004fb:	00 
  ...
  800528:	75 05                	jne    80052f <vprintfmt+0x185>
				p = "(null)";
  80052a:	be d7 0d 80 00       	mov    $0x800dd7,%esi
			if (width > 0 && padc != '-')
