	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800211:	0f be 80 90 0d 80 00 	movsbl 0x800d90(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80032c:	ff 24 95 20 0e 80 00 	jmp    *0x800e20(,%edx,4)
  ...
  8003ec:	c7 44 24 08 b1 0d 80 	movl   $0x800db1,0x8(%esp)
  8003f3:	00 
  ...
  800420:	75 05                	jne    800427 <vprintfmt+0x185>
				p = "(null)";
  800422:	be a1 0d 80 00       	mov    $0x800da1,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800a7a:	00 
  800a7b:	c7 44 24 08 94 0f 80 	movl   $0x800f94,0x8(%esp)
  800a82:	00 
  800a83:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800a8a:	00 
  800a8b:	c7 04 24 b1 0f 80 00 	movl   $0x800fb1,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800aec:	c7 04 24 c0 0f 80 00 	movl   $0x800fc0,(%esp)
  ...
  800b02:	e8 d8 f5 ff ff       	call   8000df <vcprintf>
	cprintf("\n");
  800b07:	c7 04 24 84 0d 80 00 	movl   $0x800d84,(%esp)
