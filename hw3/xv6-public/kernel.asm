...
8010003b:	c7 44 24 04 20 65 10 	movl   $0x80106520,0x4(%esp)
80100042:	80 
...
8010007e:	c7 44 24 04 27 65 10 	movl   $0x80106527,0x4(%esp)
80100085:	80 
...
80100164:	c7 04 24 2e 65 10 80 	movl   $0x8010652e,(%esp)
...
bwrite(struct buf *b)
{
  if(!holdingsleep(&b->lock))
    panic("bwrite");
80100199:	c7 04 24 3f 65 10 80 	movl   $0x8010653f,(%esp)
...
brelse(struct buf *b)
{
  if(!holdingsleep(&b->lock))
    panic("brelse");
80100222:	c7 04 24 46 65 10 80 	movl   $0x80106546,(%esp)
...
80100338:	c7 04 24 4d 65 10 80 	movl   $0x8010654d,(%esp)
...
8010034a:	e8 6d 02 00 00       	call   801005bc <cprintf>
  cprintf("\n");
8010034f:	c7 04 24 7b 6e 10 80 	movl   $0x80106e7b,(%esp)
...
80100376:	c7 04 24 61 65 10 80 	movl   $0x80106561,(%esp)
...
801003be:	e8 51 4d 00 00       	call   80105114 <uartputc>
}
...
80100462:	e8 ad 4c 00 00       	call   80105114 <uartputc>
80100467:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
8010046e:	e8 a1 4c 00 00       	call   80105114 <uartputc>
80100473:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010047a:	e8 95 4c 00 00       	call   80105114 <uartputc>
...
801004c9:	e9 5f ff ff ff       	jmp    8010042d <consputc+0x95>
  ...
  if(pos < 0 || pos > 25*80)
    panic("pos under/overflow");
801004ce:	c7 04 24 65 65 10 80 	movl   $0x80106565,(%esp)
...
8010057e:	8a 92 90 65 10 80    	mov    -0x7fef9a70(%edx),%dl
...
801006e5:	8d 76 00             	lea    0x0(%esi),%esi
    ...
    case 's':
      if((s = (char*)*argp++) == 0)
        s = "(null)";
801006e8:	ba 78 65 10 80       	mov    $0x80106578,%edx
801006ed:	eb be                	jmp    801006ad <cprintf+0xf1>
  ...
  if (fmt == 0)
    panic("null fmt");
801006ef:	c7 04 24 7f 65 10 80 	movl   $0x8010657f,(%esp)
...
8010088a:	c7 44 24 04 88 65 10 	movl   $0x80106588,0x4(%esp)
80100891:	80 
...
80100957:	75 d8                	jne    80100931 <exec+0x5d>
  ...
  if((pgdir = setupkvm()) == 0)
80100959:	e8 6e 59 00 00       	call   801062cc <setupkvm>
...
801009e6:	e8 59 57 00 00       	call   80106144 <allocuvm>
...
80100a1e:	e8 b5 55 00 00       	call   80105fd8 <loaduvm>
...
80100a35:	e8 1e 58 00 00       	call   80106258 <freevm>
  if(ip){
...
80100a81:	e8 be 56 00 00       	call   80106144 <allocuvm>
...
80100aa6:	e8 b5 58 00 00       	call   80106360 <clearpteu>
  sp = sz;
...
80100b31:	e8 5a 59 00 00       	call   80106490 <copyout>
...
80100b41:	e8 fa 1c 00 00       	call   80102840 <end_op>
    cprintf("exec: fail\n");
80100b46:	c7 04 24 a1 65 10 80 	movl   $0x801065a1,(%esp)
...
80100bac:	e8 df 58 00 00       	call   80106490 <copyout>
...
80100c24:	e8 33 52 00 00       	call   80105e5c <switchuvm>
  freevm(oldpgdir);
80100c29:	89 34 24             	mov    %esi,(%esp)
80100c2c:	e8 27 56 00 00       	call   80106258 <freevm>
  return 0;
...
80100c52:	c7 44 24 04 ad 65 10 	movl   $0x801065ad,0x4(%esp)
80100c59:	80 
...
filedup(struct file *f)
{
  ...
  if(f->ref < 1)
    panic("filedup");
80100d09:	c7 04 24 b4 65 10 80 	movl   $0x801065b4,(%esp)
...
80100dbf:	eb c4                	jmp    80100d85 <fileclose+0x6d>
{
  ...
  if(f->ref < 1)
    panic("fileclose");
80100dc1:	c7 04 24 bc 65 10 80 	movl   $0x801065bc,(%esp)
...
80100ea1:	eb da                	jmp    80100e7d <fileread+0x61>
  ...
  panic("fileread");
80100ea3:	c7 04 24 c6 65 10 80 	movl   $0x801065c6,(%esp)
...
80100fa4:	e9 73 1f 00 00       	jmp    80102f1c <pipewrite>
      ...
      if(r != n1)
        panic("short filewrite");
80100fa9:	c7 04 24 cf 65 10 80 	movl   $0x801065cf,(%esp)
80100fb0:	e8 67 f3 ff ff       	call   8010031c <panic>
  ...
  panic("filewrite");
80100fb5:	c7 04 24 d5 65 10 80 	movl   $0x801065d5,(%esp)
...
80101068:	c3                   	ret    
  ...
  if(empty == 0)
    panic("iget: no inodes");
80101069:	c7 04 24 df 65 10 80 	movl   $0x801065df,(%esp)
...
801010dd:	c3                   	ret    
  ...
  if((bp->data[bi/8] & m) == 0)
    panic("freeing free block");
801010de:	c7 04 24 ef 65 10 80 	movl   $0x801065ef,(%esp)
...
80101187:	c7 04 24 02 66 10 80 	movl   $0x80106602,(%esp)
...
8010126d:	eb aa                	jmp    80101219 <bmap.part.0+0x1d>
  ...
  panic("bmap: out of range");
8010126f:	c7 04 24 18 66 10 80 	movl   $0x80106618,(%esp)
...
801012cb:	c7 44 24 04 2b 66 10 	movl   $0x8010662b,0x4(%esp)
801012d2:	80 
...
801012e4:	c7 44 24 04 32 66 10 	movl   $0x80106632,0x4(%esp)
801012eb:	80 
...
80101357:	c7 04 24 98 66 10 80 	movl   $0x80106698,(%esp)
...
8010141e:	e9 a1 fb ff ff       	jmp    80100fc4 <iget>
  ...
  panic("ialloc: no inodes");
80101423:	c7 04 24 38 66 10 80 	movl   $0x80106638,(%esp)
...
8010159a:	0f 85 78 ff ff ff    	jne    80101518 <ilock+0x30>
      panic("ilock: no type");
801015a0:	c7 04 24 50 66 10 80 	movl   $0x80106650,(%esp)
801015a7:	e8 70 ed ff ff       	call   8010031c <panic>
{
  ...
  if(ip == 0 || ip->ref < 1)
    panic("ilock");
801015ac:	c7 04 24 4a 66 10 80 	movl   $0x8010664a,(%esp)
...
iunlock(struct inode *ip)
{
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    panic("iunlock");
801015eb:	c7 04 24 5f 66 10 80 	movl   $0x8010665f,(%esp)
...
80101aad:	c3                   	ret    
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlookup read");
80101aae:	c7 04 24 79 66 10 80 	movl   $0x80106679,(%esp)
80101ab5:	e8 62 e8 ff ff       	call   8010031c <panic>
{
  ...
  if(dp->type != T_DIR)
    panic("dirlookup not DIR");
80101aba:	c7 04 24 67 66 10 80 	movl   $0x80106667,(%esp)
...
80101cfd:	eb e9                	jmp    80101ce8 <dirlink+0xa8>
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlink read");
80101cff:	c7 04 24 88 66 10 80 	movl   $0x80106688,(%esp)
80101d06:	e8 11 e6 ff ff       	call   8010031c <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("dirlink");
80101d0b:	c7 04 24 62 6c 10 80 	movl   $0x80106c62,(%esp)
...
80101dd8:	c7 04 24 f4 66 10 80 	movl   $0x801066f4,(%esp)
...
idestart(struct buf *b)
{
  if(b == 0)
    panic("idestart");
80101de4:	c7 04 24 eb 66 10 80 	movl   $0x801066eb,(%esp)
...
80101df6:	c7 44 24 04 06 67 10 	movl   $0x80106706,0x4(%esp)
80101dfd:	80 
...
iderw(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    panic("iderw: buf not locked");
80101f9f:	c7 04 24 0a 67 10 80 	movl   $0x8010670a,(%esp)
80101fa6:	e8 71 e3 ff ff       	call   8010031c <panic>
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
  if(b->dev != 0 && !havedisk1)
    panic("iderw: ide disk 1 not present");
80101fab:	c7 04 24 35 67 10 80 	movl   $0x80106735,(%esp)
80101fb2:	e8 65 e3 ff ff       	call   8010031c <panic>
  ...
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
80101fb7:	c7 04 24 20 67 10 80 	movl   $0x80106720,(%esp)
...
80102011:	c7 04 24 54 67 10 80 	movl   $0x80106754,(%esp)
...
kfree(char *v)
{
  ...
  if((uint)v % PGSIZE || v < end || V2P(v) >= PHYSTOP)
    panic("kfree");
80102122:	c7 04 24 86 67 10 80 	movl   $0x80106786,(%esp)
...
801021aa:	c7 44 24 04 8c 67 10 	movl   $0x8010678c,0x4(%esp)
801021b1:	80 
...
80102260:	8a 80 a0 67 10 80    	mov    -0x7fef9860(%eax),%al
...
8010228c:	0f b6 90 a0 67 10 80 	movzbl -0x7fef9860(%eax),%edx
80102293:	09 ca                	or     %ecx,%edx
  shift ^= togglecode[data];
80102295:	0f b6 88 a0 68 10 80 	movzbl -0x7fef9760(%eax),%ecx
...
801022a9:	8b 0c 8d a0 69 10 80 	mov    -0x7fef9660(,%ecx,4),%ecx
...
80102753:	c7 44 24 04 b0 69 10 	movl   $0x801069b0,0x4(%esp)
8010275a:	80 
...
8010295a:	c3                   	ret    
  ...
  if(log.committing)
    panic("log.committing");
8010295b:	c7 04 24 b4 69 10 80 	movl   $0x801069b4,(%esp)
...
log_write(struct buf *b)
{
  ...
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    panic("too big a transaction");
80102a04:	c7 04 24 c3 69 10 80 	movl   $0x801069c3,(%esp)
80102a0b:	e8 0c d9 ff ff       	call   8010031c <panic>
  if (log.outstanding < 1)
    panic("log_write outside of trans");
80102a10:	c7 04 24 d9 69 10 80 	movl   $0x801069d9,(%esp)
...
80102a37:	c7 04 24 f4 69 10 80 	movl   $0x801069f4,(%esp)
80102a3e:	e8 79 db ff ff       	call   801005bc <cprintf>
  idtinit();       // load idt register
80102a43:	e8 34 24 00 00       	call   80104e7c <idtinit>
...
80102a63:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102a66:	e8 dd 33 00 00       	call   80105e48 <switchkvm>
  seginit();
80102a6b:	e8 fc 32 00 00       	call   80105d6c <seginit>
  lapicinit();
...
80102abd:	e8 9a 26 00 00       	call   8010515c <uartinit>
  pinit();         // process table
80102ac2:	e8 25 07 00 00       	call   801031ec <pinit>
  tvinit();        // trap vectors
80102ac7:	e8 2c 23 00 00       	call   80104df8 <tvinit>
  binit();         // buffer cache
...
80102bbf:	00 
80102bc0:	c7 44 24 04 08 6a 10 	movl   $0x80106a08,0x4(%esp)
80102bc7:	80 
...
80102c68:	00 
80102c69:	c7 44 24 04 0d 6a 10 	movl   $0x80106a0d,0x4(%esp)
80102c70:	80 
...
80102cf9:	ff 24 95 4c 6a 10 80 	jmp    *-0x7fef95b4(,%edx,4)
...
80102d76:	0f 85 d1 fe ff ff    	jne    80102c4d <mpinit+0x51>
  ...
  if((conf = mpconfig(&mp)) == 0)
    panic("Expect to run on an SMP");
80102d7c:	c7 04 24 12 6a 10 80 	movl   $0x80106a12,(%esp)
80102d83:	e8 94 d5 ff ff       	call   8010031c <panic>
  ...
  if(!ismp)
    panic("Didn't find a suitable machine");
80102d88:	c7 04 24 2c 6a 10 80 	movl   $0x80106a2c,(%esp)
...
80102e0d:	c7 44 24 04 60 6a 10 	movl   $0x80106a60,0x4(%esp)
80102e14:	80 
...
80103148:	c7 80 b0 0f 00 00 ec 	movl   $0x80104dec,0xfb0(%eax)
8010314f:	4d 10 80 
...
801031f2:	c7 44 24 04 65 6a 10 	movl   $0x80106a65,0x4(%esp)
801031f9:	80 
...
80103261:	eb e7                	jmp    8010324a <mycpu+0x42>
  ...
  panic("unknown apicid\n");
80103263:	c7 04 24 6c 6a 10 80 	movl   $0x80106a6c,(%esp)
...
mycpu(void)
{
  ...
  if(readeflags()&FL_IF)
    panic("mycpu called with interrupts enabled\n");
8010326f:	c7 04 24 48 6b 10 80 	movl   $0x80106b48,(%esp)
...
801032e3:	e8 e4 2f 00 00       	call   801062cc <setupkvm>
...
80103306:	e8 4d 2c 00 00       	call   80105f58 <inituvm>
  p->sz = PGSIZE;
...
801033be:	c3                   	ret    
  ...
  if((p->pgdir = setupkvm()) == 0)
    panic("userinit: out of memory?");
801033bf:	c7 04 24 7c 6a 10 80 	movl   $0x80106a7c,(%esp)
...
801033f5:	e8 4a 2d 00 00       	call   80106144 <allocuvm>
...
80103403:	e8 54 2a 00 00       	call   80105e5c <switchuvm>
  return 0;
...
80103426:	e8 71 2c 00 00       	call   8010609c <deallocuvm>
...
80103464:	e8 1f 2f 00 00       	call   80106388 <copyuvm>
...
80103592:	e8 c5 28 00 00       	call   80105e5c <switchuvm>
      p->state = RUNNING;
...
801035a8:	e8 d3 09 00 00       	call   80103f80 <swtch>
      switchkvm();
801035ad:	e8 96 28 00 00       	call   80105e48 <switchkvm>
...
80103645:	c3                   	ret    
{
  ...
  if(!holding(&ptable.lock))
    panic("sched ptable.lock");
80103646:	c7 04 24 a0 6a 10 80 	movl   $0x80106aa0,(%esp)
8010364d:	e8 ca cc ff ff       	call   8010031c <panic>
  ...
  if(readeflags()&FL_IF)
    panic("sched interruptible");
80103652:	c7 04 24 cc 6a 10 80 	movl   $0x80106acc,(%esp)
80103659:	e8 be cc ff ff       	call   8010031c <panic>
  ...
  if(p->state == RUNNING)
    panic("sched running");
8010365e:	c7 04 24 be 6a 10 80 	movl   $0x80106abe,(%esp)
80103665:	e8 b2 cc ff ff       	call   8010031c <panic>
  ...
  if(mycpu()->ncli != 1)
    panic("sched locks");
8010366a:	c7 04 24 b2 6a 10 80 	movl   $0x80106ab2,(%esp)
...
80103762:	e8 71 fe ff ff       	call   801035d8 <sched>
  panic("zombie exit");
80103767:	c7 04 24 ed 6a 10 80 	movl   $0x80106aed,(%esp)
8010376e:	e8 a9 cb ff ff       	call   8010031c <panic>
  ...
  if(curproc == initproc)
    panic("init exiting");
80103773:	c7 04 24 e0 6a 10 80 	movl   $0x80106ae0,(%esp)
...
8010383e:	c7 04 24 ff 6a 10 80 	movl   $0x80106aff,(%esp)
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  if(p == 0)
    panic("sleep");
8010384a:	c7 04 24 f9 6a 10 80 	movl   $0x80106af9,(%esp)
...
801038dc:	e8 77 29 00 00       	call   80106258 <freevm>
        p->pid = 0;
...
80103a18:	8b 04 85 70 6b 10 80 	mov    -0x7fef9490(,%eax,4),%eax
...
80103a35:	c7 04 24 14 6b 10 80 	movl   $0x80106b14,(%esp)
...
80103a45:	74 2d                	je     80103a74 <procdump+0x70>
    ...
    cprintf("\n");
80103a47:	c7 04 24 7b 6e 10 80 	movl   $0x80106e7b,(%esp)
...
80103a68:	76 ae                	jbe    80103a18 <procdump+0x14>
      ...
      state = "???";
80103a6a:	b8 10 6b 10 80       	mov    $0x80106b10,%eax
...
80103a9a:	c7 04 24 61 65 10 80 	movl   $0x80106561,(%esp)
...
80103ac2:	c7 44 24 04 88 6b 10 	movl   $0x80106b88,0x4(%esp)
80103ac9:	80 
...
popcli(void)
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
80103caa:	c7 04 24 aa 6b 10 80 	movl   $0x80106baa,(%esp)
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
80103cb6:	c7 04 24 93 6b 10 80 	movl   $0x80106b93,(%esp)
...
acquire(struct spinlock *lk)
{
  ...
  if(holding(lk))
    panic("acquire");
80103d57:	c7 04 24 b1 6b 10 80 	movl   $0x80106bb1,(%esp)
...
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
80103d9d:	c7 04 24 b9 6b 10 80 	movl   $0x80106bb9,(%esp)
...
801040dd:	83 f9 15             	cmp    $0x15,%ecx
801040e0:	77 16                	ja     801040f8 <syscall+0x30>
801040e2:	8b 0c 95 e0 6b 10 80 	mov    -0x7fef9420(,%edx,4),%ecx
...
8010410a:	c7 04 24 c1 6b 10 80 	movl   $0x80106bc1,(%esp)
...
80104296:	c7 44 24 04 4c 6c 10 	movl   $0x80106c4c,0x4(%esp)
8010429d:	80 
...
801042b4:	c7 44 24 04 4b 6c 10 	movl   $0x80106c4b,0x4(%esp)
801042bb:	80 
...
801042c9:	0f 89 78 ff ff ff    	jns    80104247 <create+0xe3>
      panic("create dots");
801042cf:	c7 04 24 4e 6c 10 80 	movl   $0x80106c4e,(%esp)
801042d6:	e8 41 c0 ff ff       	call   8010031c <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
801042db:	c7 04 24 5a 6c 10 80 	movl   $0x80106c5a,(%esp)
801042e2:	e8 35 c0 ff ff       	call   8010031c <panic>
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
801042e7:	c7 04 24 3c 6c 10 80 	movl   $0x80106c3c,(%esp)
...
80104679:	c7 44 24 04 4c 6c 10 	movl   $0x80106c4c,0x4(%esp)
80104680:	80 
...
80104691:	c7 44 24 04 4b 6c 10 	movl   $0x80106c4b,0x4(%esp)
80104698:	80 
...
801047e5:	e9 6c ff ff ff       	jmp    80104756 <sys_unlink+0x12e>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
801047ea:	c7 04 24 7c 6c 10 80 	movl   $0x80106c7c,(%esp)
801047f1:	e8 26 bb ff ff       	call   8010031c <panic>
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
801047f6:	c7 04 24 6a 6c 10 80 	movl   $0x80106c6a,(%esp)
801047fd:	e8 1a bb ff ff       	call   8010031c <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
80104802:	c7 04 24 8e 6c 10 80 	movl   $0x80106c8e,(%esp)
...
{
  return fork();
80104c5c:	e9 d7 e7 ff ff       	jmp    80103438 <fork>
80104c61:	8d 76 00             	lea    0x0(%esi),%esi
...
80104c67:	83 ec 08             	sub    $0x8,%esp
  exit();
80104c6a:	e8 09 ea ff ff       	call   80103678 <exit>
...
{
  return wait();
80104c78:	e9 db eb ff ff       	jmp    80103858 <wait>
...
80104c8d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104c94:	e8 77 f3 ff ff       	call   80104010 <argint>
80104c99:	85 c0                	test   %eax,%eax
80104c9b:	78 0f                	js     80104cac <sys_kill+0x2c>
    return -1;
  return kill(pid);
80104c9d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104ca0:	89 04 24             	mov    %eax,(%esp)
80104ca3:	e8 e4 ec ff ff       	call   8010398c <kill>
}
80104ca8:	c9                   	leave  
80104ca9:	c3                   	ret    
...
80104cb7:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80104cba:	e8 f1 e5 ff ff       	call   801032b0 <myproc>
...
80104cc8:	83 ec 24             	sub    $0x24,%esp
  int addr;
  int n;

  if(argint(0, &n) < 0)
80104ccb:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104cce:	89 44 24 04          	mov    %eax,0x4(%esp)
80104cd2:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104cd9:	e8 32 f3 ff ff       	call   80104010 <argint>
80104cde:	85 c0                	test   %eax,%eax
80104ce0:	78 1e                	js     80104d00 <sys_sbrk+0x3c>
    return -1;
  addr = myproc()->sz;
80104ce2:	e8 c9 e5 ff ff       	call   801032b0 <myproc>
80104ce7:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80104ce9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104cec:	89 04 24             	mov    %eax,(%esp)
80104cef:	e8 d8 e6 ff ff       	call   801033cc <growproc>
80104cf4:	85 c0                	test   %eax,%eax
80104cf6:	78 08                	js     80104d00 <sys_sbrk+0x3c>
  int addr;
  int n;
...
80104d05:	eb f3                	jmp    80104cfa <sys_sbrk+0x36>
80104d07:	90                   	nop
...
80104d12:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d16:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104d1d:	e8 ee f2 ff ff       	call   80104010 <argint>
80104d22:	85 c0                	test   %eax,%eax
80104d24:	78 76                	js     80104d9c <sys_sleep+0x94>
    return -1;
  acquire(&tickslock);
80104d26:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
80104d2d:	e8 ce ef ff ff       	call   80103d00 <acquire>
  ticks0 = ticks;
80104d32:	8b 1d a0 44 11 80    	mov    0x801144a0,%ebx
  while(ticks - ticks0 < n){
80104d38:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104d3b:	85 d2                	test   %edx,%edx
80104d3d:	75 25                	jne    80104d64 <sys_sleep+0x5c>
80104d3f:	eb 47                	jmp    80104d88 <sys_sleep+0x80>
80104d41:	8d 76 00             	lea    0x0(%esi),%esi
    if(myproc()->killed){
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
80104d44:	c7 44 24 04 60 3c 11 	movl   $0x80113c60,0x4(%esp)
80104d4b:	80 
80104d4c:	c7 04 24 a0 44 11 80 	movl   $0x801144a0,(%esp)
80104d53:	e8 5c ea ff ff       	call   801037b4 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80104d58:	a1 a0 44 11 80       	mov    0x801144a0,%eax
80104d5d:	29 d8                	sub    %ebx,%eax
80104d5f:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80104d62:	73 24                	jae    80104d88 <sys_sleep+0x80>
    if(myproc()->killed){
80104d64:	e8 47 e5 ff ff       	call   801032b0 <myproc>
80104d69:	8b 40 24             	mov    0x24(%eax),%eax
80104d6c:	85 c0                	test   %eax,%eax
80104d6e:	74 d4                	je     80104d44 <sys_sleep+0x3c>
      release(&tickslock);
80104d70:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
80104d77:	e8 e8 ef ff ff       	call   80103d64 <release>
      return -1;
...
80104d81:	83 c4 24             	add    $0x24,%esp
80104d84:	5b                   	pop    %ebx
80104d85:	5d                   	pop    %ebp
80104d86:	c3                   	ret    
80104d87:	90                   	nop
  ...
  release(&tickslock);
80104d88:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
80104d8f:	e8 d0 ef ff ff       	call   80103d64 <release>
  return 0;
80104d94:	31 c0                	xor    %eax,%eax
}
80104d96:	83 c4 24             	add    $0x24,%esp
80104d99:	5b                   	pop    %ebx
80104d9a:	5d                   	pop    %ebp
80104d9b:	c3                   	ret    
{
...
80104da1:	eb de                	jmp    80104d81 <sys_sleep+0x79>
80104da3:	90                   	nop
...
80104da8:	83 ec 14             	sub    $0x14,%esp
  uint xticks;

  acquire(&tickslock);
80104dab:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
80104db2:	e8 49 ef ff ff       	call   80103d00 <acquire>
  xticks = ticks;
80104db7:	8b 1d a0 44 11 80    	mov    0x801144a0,%ebx
  release(&tickslock);
80104dbd:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
80104dc4:	e8 9b ef ff ff       	call   80103d64 <release>
  return xticks;
}
80104dc9:	89 d8                	mov    %ebx,%eax
80104dcb:	83 c4 14             	add    $0x14,%esp
80104dce:	5b                   	pop    %ebx
80104dcf:	5d                   	pop    %ebp
80104dd0:	c3                   	ret    
80104dd1:	00 00                	add    %al,(%eax)
	...
...
80104dd5:	06                   	push   %es
  pushl %fs
80104dd6:	0f a0                	push   %fs
  pushl %gs
80104dd8:	0f a8                	push   %gs
  pushal
80104dda:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80104ddb:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80104ddf:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80104de1:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80104de3:	54                   	push   %esp
  call trap
80104de4:	e8 b7 00 00 00       	call   80104ea0 <trap>
  addl $4, %esp
...
80104dec:	61                   	popa   
  popl %gs
80104ded:	0f a9                	pop    %gs
  popl %fs
80104def:	0f a1                	pop    %fs
  popl %es
80104df1:	07                   	pop    %es
  popl %ds
80104df2:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80104df3:	83 c4 08             	add    $0x8,%esp
  iret
80104df6:	cf                   	iret   
	...
...
80104dfb:	83 ec 18             	sub    $0x18,%esp
  ...
  for(i = 0; i < 256; i++)
80104dfe:	31 c0                	xor    %eax,%eax
80104e00:	ba a0 3c 11 80       	mov    $0x80113ca0,%edx
80104e05:	8d 76 00             	lea    0x0(%esi),%esi
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80104e08:	8b 0c 85 08 90 10 80 	mov    -0x7fef6ff8(,%eax,4),%ecx
80104e0f:	66 89 0c c5 a0 3c 11 	mov    %cx,-0x7feec360(,%eax,8)
80104e16:	80 
80104e17:	66 c7 44 c2 02 08 00 	movw   $0x8,0x2(%edx,%eax,8)
80104e1e:	c6 44 c2 04 00       	movb   $0x0,0x4(%edx,%eax,8)
80104e23:	c6 44 c2 05 8e       	movb   $0x8e,0x5(%edx,%eax,8)
80104e28:	c1 e9 10             	shr    $0x10,%ecx
80104e2b:	66 89 4c c2 06       	mov    %cx,0x6(%edx,%eax,8)
void
tvinit(void)
{
  int i;
  ...
  for(i = 0; i < 256; i++)
80104e30:	40                   	inc    %eax
80104e31:	3d 00 01 00 00       	cmp    $0x100,%eax
80104e36:	75 d0                	jne    80104e08 <tvinit+0x10>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80104e38:	a1 08 91 10 80       	mov    0x80109108,%eax
80104e3d:	66 a3 a0 3e 11 80    	mov    %ax,0x80113ea0
80104e43:	66 c7 05 a2 3e 11 80 	movw   $0x8,0x80113ea2
80104e4a:	08 00 
80104e4c:	c6 05 a4 3e 11 80 00 	movb   $0x0,0x80113ea4
80104e53:	c6 05 a5 3e 11 80 ef 	movb   $0xef,0x80113ea5
80104e5a:	c1 e8 10             	shr    $0x10,%eax
80104e5d:	66 a3 a6 3e 11 80    	mov    %ax,0x80113ea6

  initlock(&tickslock, "time");
80104e63:	c7 44 24 04 9d 6c 10 	movl   $0x80106c9d,0x4(%esp)
80104e6a:	80 
80104e6b:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
80104e72:	e8 4d ed ff ff       	call   80103bc4 <initlock>
}
80104e77:	c9                   	leave  
80104e78:	c3                   	ret    
...
80104e7f:	83 ec 10             	sub    $0x10,%esp
static inline void
lidt(struct gatedesc *p, int size)
{
  ...
  pd[0] = size-1;
80104e82:	66 c7 45 fa ff 07    	movw   $0x7ff,-0x6(%ebp)
  pd[1] = (uint)p;
80104e88:	b8 a0 3c 11 80       	mov    $0x80113ca0,%eax
80104e8d:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80104e91:	c1 e8 10             	shr    $0x10,%eax
80104e94:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lidt (%0)" : : "r" (pd));
80104e98:	8d 45 fa             	lea    -0x6(%ebp),%eax
80104e9b:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80104e9e:	c9                   	leave  
80104e9f:	c3                   	ret    
...
80104eac:	8b 43 30             	mov    0x30(%ebx),%eax
80104eaf:	83 f8 40             	cmp    $0x40,%eax
80104eb2:	0f 84 b0 01 00 00    	je     80105068 <trap+0x1c8>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80104eb8:	83 e8 20             	sub    $0x20,%eax
80104ebb:	83 f8 1f             	cmp    $0x1f,%eax
80104ebe:	0f 86 f4 00 00 00    	jbe    80104fb8 <trap+0x118>
    lapiceoi();
    break;
...
80104ec4:	e8 e7 e3 ff ff       	call   801032b0 <myproc>
80104ec9:	85 c0                	test   %eax,%eax
80104ecb:	0f 84 e2 01 00 00    	je     801050b3 <trap+0x213>
80104ed1:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80104ed5:	0f 84 d8 01 00 00    	je     801050b3 <trap+0x213>
...
80104ede:	8b 7b 38             	mov    0x38(%ebx),%edi
80104ee1:	89 55 dc             	mov    %edx,-0x24(%ebp)
80104ee4:	e8 93 e3 ff ff       	call   8010327c <cpuid>
80104ee9:	89 c6                	mov    %eax,%esi
80104eeb:	8b 4b 34             	mov    0x34(%ebx),%ecx
80104eee:	8b 43 30             	mov    0x30(%ebx),%eax
80104ef1:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80104ef4:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80104ef7:	e8 b4 e3 ff ff       	call   801032b0 <myproc>
80104efc:	89 45 e0             	mov    %eax,-0x20(%ebp)
80104eff:	e8 ac e3 ff ff       	call   801032b0 <myproc>
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80104f04:	8b 55 dc             	mov    -0x24(%ebp),%edx
80104f07:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80104f0b:	89 7c 24 18          	mov    %edi,0x18(%esp)
80104f0f:	89 74 24 14          	mov    %esi,0x14(%esp)
80104f13:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80104f16:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80104f1a:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104f1d:	89 54 24 0c          	mov    %edx,0xc(%esp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80104f21:	8b 55 e0             	mov    -0x20(%ebp),%edx
80104f24:	83 c2 6c             	add    $0x6c,%edx
80104f27:	89 54 24 08          	mov    %edx,0x8(%esp)
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80104f2b:	8b 40 10             	mov    0x10(%eax),%eax
80104f2e:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f32:	c7 04 24 00 6d 10 80 	movl   $0x80106d00,(%esp)
80104f39:	e8 7e b6 ff ff       	call   801005bc <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80104f3e:	e8 6d e3 ff ff       	call   801032b0 <myproc>
80104f43:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
...
80104f4c:	e8 5f e3 ff ff       	call   801032b0 <myproc>
80104f51:	85 c0                	test   %eax,%eax
80104f53:	74 1c                	je     80104f71 <trap+0xd1>
80104f55:	e8 56 e3 ff ff       	call   801032b0 <myproc>
80104f5a:	8b 50 24             	mov    0x24(%eax),%edx
80104f5d:	85 d2                	test   %edx,%edx
80104f5f:	74 10                	je     80104f71 <trap+0xd1>
80104f61:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80104f65:	83 e0 03             	and    $0x3,%eax
80104f68:	83 f8 03             	cmp    $0x3,%eax
80104f6b:	0f 84 2f 01 00 00    	je     801050a0 <trap+0x200>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80104f71:	e8 3a e3 ff ff       	call   801032b0 <myproc>
80104f76:	85 c0                	test   %eax,%eax
80104f78:	74 0f                	je     80104f89 <trap+0xe9>
80104f7a:	e8 31 e3 ff ff       	call   801032b0 <myproc>
80104f7f:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80104f83:	0f 84 cb 00 00 00    	je     80105054 <trap+0x1b4>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80104f89:	e8 22 e3 ff ff       	call   801032b0 <myproc>
80104f8e:	85 c0                	test   %eax,%eax
80104f90:	74 1c                	je     80104fae <trap+0x10e>
80104f92:	e8 19 e3 ff ff       	call   801032b0 <myproc>
80104f97:	8b 40 24             	mov    0x24(%eax),%eax
80104f9a:	85 c0                	test   %eax,%eax
80104f9c:	74 10                	je     80104fae <trap+0x10e>
80104f9e:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80104fa2:	83 e0 03             	and    $0x3,%eax
80104fa5:	83 f8 03             	cmp    $0x3,%eax
80104fa8:	0f 84 e3 00 00 00    	je     80105091 <trap+0x1f1>
    exit();
}
80104fae:	83 c4 3c             	add    $0x3c,%esp
80104fb1:	5b                   	pop    %ebx
80104fb2:	5e                   	pop    %esi
80104fb3:	5f                   	pop    %edi
80104fb4:	5d                   	pop    %ebp
...
80104fb6:	66 90                	xchg   %ax,%ax
  ...
  switch(tf->trapno){
80104fb8:	ff 24 85 44 6d 10 80 	jmp    *-0x7fef92bc(,%eax,4)
80104fbf:	90                   	nop
      release(&tickslock);
    }
    lapiceoi();
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80104fc0:	e8 9b ce ff ff       	call   80101e60 <ideintr>
    lapiceoi();
80104fc5:	e8 32 d4 ff ff       	call   801023fc <lapiceoi>
    break;
80104fca:	eb 80                	jmp    80104f4c <trap+0xac>
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
...
80104fcc:	8b 7b 38             	mov    0x38(%ebx),%edi
80104fcf:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80104fd3:	e8 a4 e2 ff ff       	call   8010327c <cpuid>
80104fd8:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80104fdc:	89 74 24 08          	mov    %esi,0x8(%esp)
80104fe0:	89 44 24 04          	mov    %eax,0x4(%esp)
80104fe4:	c7 04 24 a8 6c 10 80 	movl   $0x80106ca8,(%esp)
80104feb:	e8 cc b5 ff ff       	call   801005bc <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
80104ff0:	e8 07 d4 ff ff       	call   801023fc <lapiceoi>
    break;
80104ff5:	e9 52 ff ff ff       	jmp    80104f4c <trap+0xac>
80104ffa:	66 90                	xchg   %ax,%ax
  ...
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80104ffc:	e8 eb 01 00 00       	call   801051ec <uartintr>
    lapiceoi();
80105001:	e8 f6 d3 ff ff       	call   801023fc <lapiceoi>
    break;
80105006:	e9 41 ff ff ff       	jmp    80104f4c <trap+0xac>
8010500b:	90                   	nop
    break;
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
8010500c:	e8 db d2 ff ff       	call   801022ec <kbdintr>
    lapiceoi();
80105011:	e8 e6 d3 ff ff       	call   801023fc <lapiceoi>
    break;
80105016:	e9 31 ff ff ff       	jmp    80104f4c <trap+0xac>
8010501b:	90                   	nop
    return;
  }
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
8010501c:	e8 5b e2 ff ff       	call   8010327c <cpuid>
80105021:	85 c0                	test   %eax,%eax
80105023:	75 a0                	jne    80104fc5 <trap+0x125>
      acquire(&tickslock);
80105025:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
8010502c:	e8 cf ec ff ff       	call   80103d00 <acquire>
      ticks++;
80105031:	ff 05 a0 44 11 80    	incl   0x801144a0
      wakeup(&ticks);
80105037:	c7 04 24 a0 44 11 80 	movl   $0x801144a0,(%esp)
8010503e:	e8 ed e8 ff ff       	call   80103930 <wakeup>
      release(&tickslock);
80105043:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
8010504a:	e8 15 ed ff ff       	call   80103d64 <release>
8010504f:	e9 71 ff ff ff       	jmp    80104fc5 <trap+0x125>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
    exit();
  ...
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105054:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105058:	0f 85 2b ff ff ff    	jne    80104f89 <trap+0xe9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
8010505e:	e8 1d e7 ff ff       	call   80103780 <yield>
80105063:	e9 21 ff ff ff       	jmp    80104f89 <trap+0xe9>
//PAGEBREAK: 41
void
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
80105068:	e8 43 e2 ff ff       	call   801032b0 <myproc>
8010506d:	8b 70 24             	mov    0x24(%eax),%esi
80105070:	85 f6                	test   %esi,%esi
80105072:	75 38                	jne    801050ac <trap+0x20c>
      exit();
    myproc()->tf = tf;
80105074:	e8 37 e2 ff ff       	call   801032b0 <myproc>
80105079:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
8010507c:	e8 47 f0 ff ff       	call   801040c8 <syscall>
    if(myproc()->killed)
80105081:	e8 2a e2 ff ff       	call   801032b0 <myproc>
80105086:	8b 48 24             	mov    0x24(%eax),%ecx
80105089:	85 c9                	test   %ecx,%ecx
8010508b:	0f 84 1d ff ff ff    	je     80104fae <trap+0x10e>
    yield();
...
80105091:	83 c4 3c             	add    $0x3c,%esp
80105094:	5b                   	pop    %ebx
80105095:	5e                   	pop    %esi
80105096:	5f                   	pop    %edi
80105097:	5d                   	pop    %ebp
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
    exit();
80105098:	e9 db e5 ff ff       	jmp    80103678 <exit>
8010509d:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
    exit();
801050a0:	e8 d3 e5 ff ff       	call   80103678 <exit>
801050a5:	e9 c7 fe ff ff       	jmp    80104f71 <trap+0xd1>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
801050ac:	e8 c7 e5 ff ff       	call   80103678 <exit>
801050b1:	eb c1                	jmp    80105074 <trap+0x1d4>
801050b3:	0f 20 d7             	mov    %cr2,%edi
  ...
  default:
    if(myproc() == 0 || (tf->cs&3) == 0){
      ...
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801050b6:	8b 73 38             	mov    0x38(%ebx),%esi
801050b9:	e8 be e1 ff ff       	call   8010327c <cpuid>
801050be:	89 7c 24 10          	mov    %edi,0x10(%esp)
801050c2:	89 74 24 0c          	mov    %esi,0xc(%esp)
801050c6:	89 44 24 08          	mov    %eax,0x8(%esp)
801050ca:	8b 43 30             	mov    0x30(%ebx),%eax
801050cd:	89 44 24 04          	mov    %eax,0x4(%esp)
801050d1:	c7 04 24 cc 6c 10 80 	movl   $0x80106ccc,(%esp)
801050d8:	e8 df b4 ff ff       	call   801005bc <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
801050dd:	c7 04 24 a2 6c 10 80 	movl   $0x80106ca2,(%esp)
801050e4:	e8 33 b2 ff ff       	call   8010031c <panic>
801050e9:	00 00                	add    %al,(%eax)
	...
...
801050ed:	89 e5                	mov    %esp,%ebp
  if(!uart)
801050ef:	a1 a4 95 10 80       	mov    0x801095a4,%eax
801050f4:	85 c0                	test   %eax,%eax
801050f6:	74 14                	je     8010510c <uartgetc+0x20>
static inline uchar
inb(ushort port)
{
  uchar data;
  ...
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801050f8:	ba fd 03 00 00       	mov    $0x3fd,%edx
801050fd:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
801050fe:	a8 01                	test   $0x1,%al
80105100:	74 0a                	je     8010510c <uartgetc+0x20>
80105102:	b2 f8                	mov    $0xf8,%dl
80105104:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
80105105:	0f b6 c0             	movzbl %al,%eax
}
80105108:	5d                   	pop    %ebp
80105109:	c3                   	ret    
...
80105119:	83 ec 10             	sub    $0x10,%esp
  ...
  if(!uart)
8010511c:	8b 15 a4 95 10 80    	mov    0x801095a4,%edx
80105122:	85 d2                	test   %edx,%edx
80105124:	74 2d                	je     80105153 <uartputc+0x3f>
80105126:	bb 80 00 00 00       	mov    $0x80,%ebx
8010512b:	be fd 03 00 00       	mov    $0x3fd,%esi
80105130:	eb 11                	jmp    80105143 <uartputc+0x2f>
80105132:	66 90                	xchg   %ax,%ax
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
    microdelay(10);
80105134:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
8010513b:	e8 d8 d2 ff ff       	call   80102418 <microdelay>
{
  int i;
  ...
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105140:	4b                   	dec    %ebx
80105141:	74 07                	je     8010514a <uartputc+0x36>
80105143:	89 f2                	mov    %esi,%edx
80105145:	ec                   	in     (%dx),%al
80105146:	a8 20                	test   $0x20,%al
80105148:	74 ea                	je     80105134 <uartputc+0x20>
}
...
{
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
8010514a:	ba f8 03 00 00       	mov    $0x3f8,%edx
...
80105165:	be fa 03 00 00       	mov    $0x3fa,%esi
8010516a:	31 c0                	xor    %eax,%eax
8010516c:	89 f2                	mov    %esi,%edx
8010516e:	ee                   	out    %al,(%dx)
8010516f:	bb fb 03 00 00       	mov    $0x3fb,%ebx
80105174:	b0 80                	mov    $0x80,%al
80105176:	89 da                	mov    %ebx,%edx
80105178:	ee                   	out    %al,(%dx)
80105179:	bf f8 03 00 00       	mov    $0x3f8,%edi
8010517e:	b0 0c                	mov    $0xc,%al
80105180:	89 fa                	mov    %edi,%edx
80105182:	ee                   	out    %al,(%dx)
80105183:	b9 f9 03 00 00       	mov    $0x3f9,%ecx
80105188:	31 c0                	xor    %eax,%eax
8010518a:	89 ca                	mov    %ecx,%edx
8010518c:	ee                   	out    %al,(%dx)
8010518d:	b0 03                	mov    $0x3,%al
8010518f:	89 da                	mov    %ebx,%edx
80105191:	ee                   	out    %al,(%dx)
80105192:	b2 fc                	mov    $0xfc,%dl
80105194:	31 c0                	xor    %eax,%eax
80105196:	ee                   	out    %al,(%dx)
80105197:	b0 01                	mov    $0x1,%al
80105199:	89 ca                	mov    %ecx,%edx
...
8010519e:	ec                   	in     (%dx),%al
  ...
  if(inb(COM1+5) == 0xFF)
8010519f:	fe c0                	inc    %al
801051a1:	74 3f                	je     801051e2 <uartinit+0x86>
    return;
  uart = 1;
801051a3:	c7 05 a4 95 10 80 01 	movl   $0x1,0x801095a4
801051aa:	00 00 00 
801051ad:	89 f2                	mov    %esi,%edx
801051af:	ec                   	in     (%dx),%al
801051b0:	89 fa                	mov    %edi,%edx
...
801051b3:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801051ba:	00 
801051bb:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
801051c2:	e8 9d ce ff ff       	call   80102064 <ioapicenable>

  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
801051c7:	b0 78                	mov    $0x78,%al
801051c9:	bb c4 6d 10 80       	mov    $0x80106dc4,%ebx
801051ce:	66 90                	xchg   %ax,%ax
    uartputc(*p);
801051d0:	0f be c0             	movsbl %al,%eax
801051d3:	89 04 24             	mov    %eax,(%esp)
801051d6:	e8 39 ff ff ff       	call   80105114 <uartputc>
  inb(COM1+2);
  inb(COM1+0);
  ioapicenable(IRQ_COM1, 0);
  ...
  for(p="xv6...\n"; *p; p++)
801051db:	43                   	inc    %ebx
801051dc:	8a 03                	mov    (%ebx),%al
801051de:	84 c0                	test   %al,%al
801051e0:	75 ee                	jne    801051d0 <uartinit+0x74>
    uartputc(*p);
}
801051e2:	83 c4 1c             	add    $0x1c,%esp
801051e5:	5b                   	pop    %ebx
801051e6:	5e                   	pop    %esi
801051e7:	5f                   	pop    %edi
801051e8:	5d                   	pop    %ebp
...
801051f2:	c7 04 24 ec 50 10 80 	movl   $0x801050ec,(%esp)
801051f9:	e8 fe b4 ff ff       	call   801006fc <consoleintr>
}
801051fe:	c9                   	leave  
801051ff:	c3                   	ret    
...
80105202:	6a 00                	push   $0x0
  jmp alltraps
80105204:	e9 cb fb ff ff       	jmp    80104dd4 <alltraps>
...
8010520b:	6a 01                	push   $0x1
  jmp alltraps
8010520d:	e9 c2 fb ff ff       	jmp    80104dd4 <alltraps>
...
80105214:	6a 02                	push   $0x2
  jmp alltraps
80105216:	e9 b9 fb ff ff       	jmp    80104dd4 <alltraps>
...
8010521d:	6a 03                	push   $0x3
  jmp alltraps
8010521f:	e9 b0 fb ff ff       	jmp    80104dd4 <alltraps>
...
80105226:	6a 04                	push   $0x4
  jmp alltraps
80105228:	e9 a7 fb ff ff       	jmp    80104dd4 <alltraps>
...
8010522f:	6a 05                	push   $0x5
  jmp alltraps
80105231:	e9 9e fb ff ff       	jmp    80104dd4 <alltraps>
...
80105238:	6a 06                	push   $0x6
  jmp alltraps
8010523a:	e9 95 fb ff ff       	jmp    80104dd4 <alltraps>
...
80105241:	6a 07                	push   $0x7
  jmp alltraps
80105243:	e9 8c fb ff ff       	jmp    80104dd4 <alltraps>
...
80105248:	6a 08                	push   $0x8
  jmp alltraps
8010524a:	e9 85 fb ff ff       	jmp    80104dd4 <alltraps>
...
80105251:	6a 09                	push   $0x9
  jmp alltraps
80105253:	e9 7c fb ff ff       	jmp    80104dd4 <alltraps>
...
80105258:	6a 0a                	push   $0xa
  jmp alltraps
8010525a:	e9 75 fb ff ff       	jmp    80104dd4 <alltraps>
...
8010525f:	6a 0b                	push   $0xb
  jmp alltraps
80105261:	e9 6e fb ff ff       	jmp    80104dd4 <alltraps>
...
80105266:	6a 0c                	push   $0xc
  jmp alltraps
80105268:	e9 67 fb ff ff       	jmp    80104dd4 <alltraps>
...
8010526d:	6a 0d                	push   $0xd
  jmp alltraps
8010526f:	e9 60 fb ff ff       	jmp    80104dd4 <alltraps>
...
80105274:	6a 0e                	push   $0xe
  jmp alltraps
80105276:	e9 59 fb ff ff       	jmp    80104dd4 <alltraps>
...
8010527d:	6a 0f                	push   $0xf
  jmp alltraps
8010527f:	e9 50 fb ff ff       	jmp    80104dd4 <alltraps>
...
80105286:	6a 10                	push   $0x10
  jmp alltraps
80105288:	e9 47 fb ff ff       	jmp    80104dd4 <alltraps>
...
8010528d:	6a 11                	push   $0x11
  jmp alltraps
8010528f:	e9 40 fb ff ff       	jmp    80104dd4 <alltraps>
...
80105296:	6a 12                	push   $0x12
  jmp alltraps
80105298:	e9 37 fb ff ff       	jmp    80104dd4 <alltraps>
...
8010529f:	6a 13                	push   $0x13
  jmp alltraps
801052a1:	e9 2e fb ff ff       	jmp    80104dd4 <alltraps>
...
801052a8:	6a 14                	push   $0x14
  jmp alltraps
801052aa:	e9 25 fb ff ff       	jmp    80104dd4 <alltraps>
...
801052b1:	6a 15                	push   $0x15
  jmp alltraps
801052b3:	e9 1c fb ff ff       	jmp    80104dd4 <alltraps>
...
801052ba:	6a 16                	push   $0x16
  jmp alltraps
801052bc:	e9 13 fb ff ff       	jmp    80104dd4 <alltraps>
...
801052c3:	6a 17                	push   $0x17
  jmp alltraps
801052c5:	e9 0a fb ff ff       	jmp    80104dd4 <alltraps>
...
801052cc:	6a 18                	push   $0x18
  jmp alltraps
801052ce:	e9 01 fb ff ff       	jmp    80104dd4 <alltraps>
...
801052d5:	6a 19                	push   $0x19
  jmp alltraps
801052d7:	e9 f8 fa ff ff       	jmp    80104dd4 <alltraps>
...
801052de:	6a 1a                	push   $0x1a
  jmp alltraps
801052e0:	e9 ef fa ff ff       	jmp    80104dd4 <alltraps>
...
801052e7:	6a 1b                	push   $0x1b
  jmp alltraps
801052e9:	e9 e6 fa ff ff       	jmp    80104dd4 <alltraps>
...
801052f0:	6a 1c                	push   $0x1c
  jmp alltraps
801052f2:	e9 dd fa ff ff       	jmp    80104dd4 <alltraps>
...
801052f9:	6a 1d                	push   $0x1d
  jmp alltraps
801052fb:	e9 d4 fa ff ff       	jmp    80104dd4 <alltraps>
...
80105302:	6a 1e                	push   $0x1e
  jmp alltraps
80105304:	e9 cb fa ff ff       	jmp    80104dd4 <alltraps>
...
8010530b:	6a 1f                	push   $0x1f
  jmp alltraps
8010530d:	e9 c2 fa ff ff       	jmp    80104dd4 <alltraps>
...
80105314:	6a 20                	push   $0x20
  jmp alltraps
80105316:	e9 b9 fa ff ff       	jmp    80104dd4 <alltraps>
...
8010531d:	6a 21                	push   $0x21
  jmp alltraps
8010531f:	e9 b0 fa ff ff       	jmp    80104dd4 <alltraps>
...
80105326:	6a 22                	push   $0x22
  jmp alltraps
80105328:	e9 a7 fa ff ff       	jmp    80104dd4 <alltraps>
...
8010532f:	6a 23                	push   $0x23
  jmp alltraps
80105331:	e9 9e fa ff ff       	jmp    80104dd4 <alltraps>
...
80105338:	6a 24                	push   $0x24
  jmp alltraps
8010533a:	e9 95 fa ff ff       	jmp    80104dd4 <alltraps>
...
80105341:	6a 25                	push   $0x25
  jmp alltraps
80105343:	e9 8c fa ff ff       	jmp    80104dd4 <alltraps>
...
8010534a:	6a 26                	push   $0x26
  jmp alltraps
8010534c:	e9 83 fa ff ff       	jmp    80104dd4 <alltraps>
...
80105353:	6a 27                	push   $0x27
  jmp alltraps
80105355:	e9 7a fa ff ff       	jmp    80104dd4 <alltraps>
...
8010535c:	6a 28                	push   $0x28
  jmp alltraps
8010535e:	e9 71 fa ff ff       	jmp    80104dd4 <alltraps>
...
80105365:	6a 29                	push   $0x29
  jmp alltraps
80105367:	e9 68 fa ff ff       	jmp    80104dd4 <alltraps>
...
8010536e:	6a 2a                	push   $0x2a
  jmp alltraps
80105370:	e9 5f fa ff ff       	jmp    80104dd4 <alltraps>
...
80105377:	6a 2b                	push   $0x2b
  jmp alltraps
80105379:	e9 56 fa ff ff       	jmp    80104dd4 <alltraps>
...
80105380:	6a 2c                	push   $0x2c
  jmp alltraps
80105382:	e9 4d fa ff ff       	jmp    80104dd4 <alltraps>
...
80105389:	6a 2d                	push   $0x2d
  jmp alltraps
8010538b:	e9 44 fa ff ff       	jmp    80104dd4 <alltraps>
...
80105392:	6a 2e                	push   $0x2e
  jmp alltraps
80105394:	e9 3b fa ff ff       	jmp    80104dd4 <alltraps>
...
8010539b:	6a 2f                	push   $0x2f
  jmp alltraps
8010539d:	e9 32 fa ff ff       	jmp    80104dd4 <alltraps>
...
801053a4:	6a 30                	push   $0x30
  jmp alltraps
801053a6:	e9 29 fa ff ff       	jmp    80104dd4 <alltraps>
...
801053ad:	6a 31                	push   $0x31
  jmp alltraps
801053af:	e9 20 fa ff ff       	jmp    80104dd4 <alltraps>
...
801053b6:	6a 32                	push   $0x32
  jmp alltraps
801053b8:	e9 17 fa ff ff       	jmp    80104dd4 <alltraps>
...
801053bf:	6a 33                	push   $0x33
  jmp alltraps
801053c1:	e9 0e fa ff ff       	jmp    80104dd4 <alltraps>
...
801053c8:	6a 34                	push   $0x34
  jmp alltraps
801053ca:	e9 05 fa ff ff       	jmp    80104dd4 <alltraps>
...
801053d1:	6a 35                	push   $0x35
  jmp alltraps
801053d3:	e9 fc f9 ff ff       	jmp    80104dd4 <alltraps>
...
801053da:	6a 36                	push   $0x36
  jmp alltraps
801053dc:	e9 f3 f9 ff ff       	jmp    80104dd4 <alltraps>
...
801053e3:	6a 37                	push   $0x37
  jmp alltraps
801053e5:	e9 ea f9 ff ff       	jmp    80104dd4 <alltraps>
...
801053ec:	6a 38                	push   $0x38
  jmp alltraps
801053ee:	e9 e1 f9 ff ff       	jmp    80104dd4 <alltraps>
...
801053f5:	6a 39                	push   $0x39
  jmp alltraps
801053f7:	e9 d8 f9 ff ff       	jmp    80104dd4 <alltraps>
...
801053fe:	6a 3a                	push   $0x3a
  jmp alltraps
80105400:	e9 cf f9 ff ff       	jmp    80104dd4 <alltraps>
...
80105407:	6a 3b                	push   $0x3b
  jmp alltraps
80105409:	e9 c6 f9 ff ff       	jmp    80104dd4 <alltraps>
...
80105410:	6a 3c                	push   $0x3c
  jmp alltraps
80105412:	e9 bd f9 ff ff       	jmp    80104dd4 <alltraps>
...
80105419:	6a 3d                	push   $0x3d
  jmp alltraps
8010541b:	e9 b4 f9 ff ff       	jmp    80104dd4 <alltraps>
...
80105422:	6a 3e                	push   $0x3e
  jmp alltraps
80105424:	e9 ab f9 ff ff       	jmp    80104dd4 <alltraps>
...
8010542b:	6a 3f                	push   $0x3f
  jmp alltraps
8010542d:	e9 a2 f9 ff ff       	jmp    80104dd4 <alltraps>
...
80105434:	6a 40                	push   $0x40
  jmp alltraps
80105436:	e9 99 f9 ff ff       	jmp    80104dd4 <alltraps>
...
8010543d:	6a 41                	push   $0x41
  jmp alltraps
8010543f:	e9 90 f9 ff ff       	jmp    80104dd4 <alltraps>
...
80105446:	6a 42                	push   $0x42
  jmp alltraps
80105448:	e9 87 f9 ff ff       	jmp    80104dd4 <alltraps>
...
8010544f:	6a 43                	push   $0x43
  jmp alltraps
80105451:	e9 7e f9 ff ff       	jmp    80104dd4 <alltraps>
...
80105458:	6a 44                	push   $0x44
  jmp alltraps
8010545a:	e9 75 f9 ff ff       	jmp    80104dd4 <alltraps>
...
80105461:	6a 45                	push   $0x45
  jmp alltraps
80105463:	e9 6c f9 ff ff       	jmp    80104dd4 <alltraps>
...
8010546a:	6a 46                	push   $0x46
  jmp alltraps
8010546c:	e9 63 f9 ff ff       	jmp    80104dd4 <alltraps>
...
80105473:	6a 47                	push   $0x47
  jmp alltraps
80105475:	e9 5a f9 ff ff       	jmp    80104dd4 <alltraps>
...
8010547c:	6a 48                	push   $0x48
  jmp alltraps
8010547e:	e9 51 f9 ff ff       	jmp    80104dd4 <alltraps>
...
80105485:	6a 49                	push   $0x49
  jmp alltraps
80105487:	e9 48 f9 ff ff       	jmp    80104dd4 <alltraps>
...
8010548e:	6a 4a                	push   $0x4a
  jmp alltraps
80105490:	e9 3f f9 ff ff       	jmp    80104dd4 <alltraps>
...
80105497:	6a 4b                	push   $0x4b
  jmp alltraps
80105499:	e9 36 f9 ff ff       	jmp    80104dd4 <alltraps>
...
801054a0:	6a 4c                	push   $0x4c
  jmp alltraps
801054a2:	e9 2d f9 ff ff       	jmp    80104dd4 <alltraps>
...
801054a9:	6a 4d                	push   $0x4d
  jmp alltraps
801054ab:	e9 24 f9 ff ff       	jmp    80104dd4 <alltraps>
...
801054b2:	6a 4e                	push   $0x4e
  jmp alltraps
801054b4:	e9 1b f9 ff ff       	jmp    80104dd4 <alltraps>
...
801054bb:	6a 4f                	push   $0x4f
  jmp alltraps
801054bd:	e9 12 f9 ff ff       	jmp    80104dd4 <alltraps>
...
801054c4:	6a 50                	push   $0x50
  jmp alltraps
801054c6:	e9 09 f9 ff ff       	jmp    80104dd4 <alltraps>
...
801054cd:	6a 51                	push   $0x51
  jmp alltraps
801054cf:	e9 00 f9 ff ff       	jmp    80104dd4 <alltraps>
...
801054d6:	6a 52                	push   $0x52
  jmp alltraps
801054d8:	e9 f7 f8 ff ff       	jmp    80104dd4 <alltraps>
...
801054df:	6a 53                	push   $0x53
  jmp alltraps
801054e1:	e9 ee f8 ff ff       	jmp    80104dd4 <alltraps>
...
801054e8:	6a 54                	push   $0x54
  jmp alltraps
801054ea:	e9 e5 f8 ff ff       	jmp    80104dd4 <alltraps>
...
801054f1:	6a 55                	push   $0x55
  jmp alltraps
801054f3:	e9 dc f8 ff ff       	jmp    80104dd4 <alltraps>
...
801054fa:	6a 56                	push   $0x56
  jmp alltraps
801054fc:	e9 d3 f8 ff ff       	jmp    80104dd4 <alltraps>
...
80105503:	6a 57                	push   $0x57
  jmp alltraps
80105505:	e9 ca f8 ff ff       	jmp    80104dd4 <alltraps>
...
8010550c:	6a 58                	push   $0x58
  jmp alltraps
8010550e:	e9 c1 f8 ff ff       	jmp    80104dd4 <alltraps>
...
80105515:	6a 59                	push   $0x59
  jmp alltraps
80105517:	e9 b8 f8 ff ff       	jmp    80104dd4 <alltraps>
...
8010551e:	6a 5a                	push   $0x5a
  jmp alltraps
80105520:	e9 af f8 ff ff       	jmp    80104dd4 <alltraps>
...
80105527:	6a 5b                	push   $0x5b
  jmp alltraps
80105529:	e9 a6 f8 ff ff       	jmp    80104dd4 <alltraps>
...
80105530:	6a 5c                	push   $0x5c
  jmp alltraps
80105532:	e9 9d f8 ff ff       	jmp    80104dd4 <alltraps>
...
80105539:	6a 5d                	push   $0x5d
  jmp alltraps
8010553b:	e9 94 f8 ff ff       	jmp    80104dd4 <alltraps>
...
80105542:	6a 5e                	push   $0x5e
  jmp alltraps
80105544:	e9 8b f8 ff ff       	jmp    80104dd4 <alltraps>
...
8010554b:	6a 5f                	push   $0x5f
  jmp alltraps
8010554d:	e9 82 f8 ff ff       	jmp    80104dd4 <alltraps>
...
80105554:	6a 60                	push   $0x60
  jmp alltraps
80105556:	e9 79 f8 ff ff       	jmp    80104dd4 <alltraps>
...
8010555d:	6a 61                	push   $0x61
  jmp alltraps
8010555f:	e9 70 f8 ff ff       	jmp    80104dd4 <alltraps>
...
80105566:	6a 62                	push   $0x62
  jmp alltraps
80105568:	e9 67 f8 ff ff       	jmp    80104dd4 <alltraps>
...
8010556f:	6a 63                	push   $0x63
  jmp alltraps
80105571:	e9 5e f8 ff ff       	jmp    80104dd4 <alltraps>
...
80105578:	6a 64                	push   $0x64
  jmp alltraps
8010557a:	e9 55 f8 ff ff       	jmp    80104dd4 <alltraps>
...
80105581:	6a 65                	push   $0x65
  jmp alltraps
80105583:	e9 4c f8 ff ff       	jmp    80104dd4 <alltraps>
...
8010558a:	6a 66                	push   $0x66
  jmp alltraps
8010558c:	e9 43 f8 ff ff       	jmp    80104dd4 <alltraps>
...
80105593:	6a 67                	push   $0x67
  jmp alltraps
80105595:	e9 3a f8 ff ff       	jmp    80104dd4 <alltraps>
...
8010559c:	6a 68                	push   $0x68
  jmp alltraps
8010559e:	e9 31 f8 ff ff       	jmp    80104dd4 <alltraps>
...
801055a5:	6a 69                	push   $0x69
  jmp alltraps
801055a7:	e9 28 f8 ff ff       	jmp    80104dd4 <alltraps>
...
801055ae:	6a 6a                	push   $0x6a
  jmp alltraps
801055b0:	e9 1f f8 ff ff       	jmp    80104dd4 <alltraps>
...
801055b7:	6a 6b                	push   $0x6b
  jmp alltraps
801055b9:	e9 16 f8 ff ff       	jmp    80104dd4 <alltraps>
...
801055c0:	6a 6c                	push   $0x6c
  jmp alltraps
801055c2:	e9 0d f8 ff ff       	jmp    80104dd4 <alltraps>
...
801055c9:	6a 6d                	push   $0x6d
  jmp alltraps
801055cb:	e9 04 f8 ff ff       	jmp    80104dd4 <alltraps>
...
801055d2:	6a 6e                	push   $0x6e
  jmp alltraps
801055d4:	e9 fb f7 ff ff       	jmp    80104dd4 <alltraps>
...
801055db:	6a 6f                	push   $0x6f
  jmp alltraps
801055dd:	e9 f2 f7 ff ff       	jmp    80104dd4 <alltraps>
...
801055e4:	6a 70                	push   $0x70
  jmp alltraps
801055e6:	e9 e9 f7 ff ff       	jmp    80104dd4 <alltraps>
...
801055ed:	6a 71                	push   $0x71
  jmp alltraps
801055ef:	e9 e0 f7 ff ff       	jmp    80104dd4 <alltraps>
...
801055f6:	6a 72                	push   $0x72
  jmp alltraps
801055f8:	e9 d7 f7 ff ff       	jmp    80104dd4 <alltraps>
...
801055ff:	6a 73                	push   $0x73
  jmp alltraps
80105601:	e9 ce f7 ff ff       	jmp    80104dd4 <alltraps>
...
80105608:	6a 74                	push   $0x74
  jmp alltraps
8010560a:	e9 c5 f7 ff ff       	jmp    80104dd4 <alltraps>
...
80105611:	6a 75                	push   $0x75
  jmp alltraps
80105613:	e9 bc f7 ff ff       	jmp    80104dd4 <alltraps>
...
8010561a:	6a 76                	push   $0x76
  jmp alltraps
8010561c:	e9 b3 f7 ff ff       	jmp    80104dd4 <alltraps>
...
80105623:	6a 77                	push   $0x77
  jmp alltraps
80105625:	e9 aa f7 ff ff       	jmp    80104dd4 <alltraps>
...
8010562c:	6a 78                	push   $0x78
  jmp alltraps
8010562e:	e9 a1 f7 ff ff       	jmp    80104dd4 <alltraps>
...
80105635:	6a 79                	push   $0x79
  jmp alltraps
80105637:	e9 98 f7 ff ff       	jmp    80104dd4 <alltraps>
...
8010563e:	6a 7a                	push   $0x7a
  jmp alltraps
80105640:	e9 8f f7 ff ff       	jmp    80104dd4 <alltraps>
...
80105647:	6a 7b                	push   $0x7b
  jmp alltraps
80105649:	e9 86 f7 ff ff       	jmp    80104dd4 <alltraps>
...
80105650:	6a 7c                	push   $0x7c
  jmp alltraps
80105652:	e9 7d f7 ff ff       	jmp    80104dd4 <alltraps>
...
80105659:	6a 7d                	push   $0x7d
  jmp alltraps
8010565b:	e9 74 f7 ff ff       	jmp    80104dd4 <alltraps>
...
80105662:	6a 7e                	push   $0x7e
  jmp alltraps
80105664:	e9 6b f7 ff ff       	jmp    80104dd4 <alltraps>
...
8010566b:	6a 7f                	push   $0x7f
  jmp alltraps
8010566d:	e9 62 f7 ff ff       	jmp    80104dd4 <alltraps>
...
80105674:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105679:	e9 56 f7 ff ff       	jmp    80104dd4 <alltraps>
...
80105680:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105685:	e9 4a f7 ff ff       	jmp    80104dd4 <alltraps>
...
8010568c:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105691:	e9 3e f7 ff ff       	jmp    80104dd4 <alltraps>
...
80105698:	68 83 00 00 00       	push   $0x83
  jmp alltraps
8010569d:	e9 32 f7 ff ff       	jmp    80104dd4 <alltraps>
...
801056a4:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801056a9:	e9 26 f7 ff ff       	jmp    80104dd4 <alltraps>
...
801056b0:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801056b5:	e9 1a f7 ff ff       	jmp    80104dd4 <alltraps>
...
801056bc:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801056c1:	e9 0e f7 ff ff       	jmp    80104dd4 <alltraps>
...
801056c8:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801056cd:	e9 02 f7 ff ff       	jmp    80104dd4 <alltraps>
...
801056d4:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801056d9:	e9 f6 f6 ff ff       	jmp    80104dd4 <alltraps>
...
801056e0:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801056e5:	e9 ea f6 ff ff       	jmp    80104dd4 <alltraps>
...
801056ec:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801056f1:	e9 de f6 ff ff       	jmp    80104dd4 <alltraps>
...
801056f8:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801056fd:	e9 d2 f6 ff ff       	jmp    80104dd4 <alltraps>
...
80105704:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105709:	e9 c6 f6 ff ff       	jmp    80104dd4 <alltraps>
...
80105710:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80105715:	e9 ba f6 ff ff       	jmp    80104dd4 <alltraps>
...
8010571c:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80105721:	e9 ae f6 ff ff       	jmp    80104dd4 <alltraps>
...
80105728:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
8010572d:	e9 a2 f6 ff ff       	jmp    80104dd4 <alltraps>
...
80105734:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80105739:	e9 96 f6 ff ff       	jmp    80104dd4 <alltraps>
...
80105740:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80105745:	e9 8a f6 ff ff       	jmp    80104dd4 <alltraps>
...
8010574c:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80105751:	e9 7e f6 ff ff       	jmp    80104dd4 <alltraps>
...
80105758:	68 93 00 00 00       	push   $0x93
  jmp alltraps
8010575d:	e9 72 f6 ff ff       	jmp    80104dd4 <alltraps>
...
80105764:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80105769:	e9 66 f6 ff ff       	jmp    80104dd4 <alltraps>
...
80105770:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80105775:	e9 5a f6 ff ff       	jmp    80104dd4 <alltraps>
...
8010577c:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80105781:	e9 4e f6 ff ff       	jmp    80104dd4 <alltraps>
...
80105788:	68 97 00 00 00       	push   $0x97
  jmp alltraps
8010578d:	e9 42 f6 ff ff       	jmp    80104dd4 <alltraps>
...
80105794:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105799:	e9 36 f6 ff ff       	jmp    80104dd4 <alltraps>
...
801057a0:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801057a5:	e9 2a f6 ff ff       	jmp    80104dd4 <alltraps>
...
801057ac:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801057b1:	e9 1e f6 ff ff       	jmp    80104dd4 <alltraps>
...
801057b8:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801057bd:	e9 12 f6 ff ff       	jmp    80104dd4 <alltraps>
...
801057c4:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801057c9:	e9 06 f6 ff ff       	jmp    80104dd4 <alltraps>
...
801057d0:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801057d5:	e9 fa f5 ff ff       	jmp    80104dd4 <alltraps>
...
801057dc:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801057e1:	e9 ee f5 ff ff       	jmp    80104dd4 <alltraps>
...
801057e8:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801057ed:	e9 e2 f5 ff ff       	jmp    80104dd4 <alltraps>
...
801057f4:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801057f9:	e9 d6 f5 ff ff       	jmp    80104dd4 <alltraps>
...
80105800:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80105805:	e9 ca f5 ff ff       	jmp    80104dd4 <alltraps>
...
8010580c:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80105811:	e9 be f5 ff ff       	jmp    80104dd4 <alltraps>
...
80105818:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
8010581d:	e9 b2 f5 ff ff       	jmp    80104dd4 <alltraps>
...
80105824:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80105829:	e9 a6 f5 ff ff       	jmp    80104dd4 <alltraps>
...
80105830:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80105835:	e9 9a f5 ff ff       	jmp    80104dd4 <alltraps>
...
8010583c:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80105841:	e9 8e f5 ff ff       	jmp    80104dd4 <alltraps>
...
80105848:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
8010584d:	e9 82 f5 ff ff       	jmp    80104dd4 <alltraps>
...
80105854:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80105859:	e9 76 f5 ff ff       	jmp    80104dd4 <alltraps>
...
80105860:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80105865:	e9 6a f5 ff ff       	jmp    80104dd4 <alltraps>
...
8010586c:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80105871:	e9 5e f5 ff ff       	jmp    80104dd4 <alltraps>
...
80105878:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
8010587d:	e9 52 f5 ff ff       	jmp    80104dd4 <alltraps>
...
80105884:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80105889:	e9 46 f5 ff ff       	jmp    80104dd4 <alltraps>
...
80105890:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80105895:	e9 3a f5 ff ff       	jmp    80104dd4 <alltraps>
...
8010589c:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801058a1:	e9 2e f5 ff ff       	jmp    80104dd4 <alltraps>
...
801058a8:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801058ad:	e9 22 f5 ff ff       	jmp    80104dd4 <alltraps>
...
801058b4:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801058b9:	e9 16 f5 ff ff       	jmp    80104dd4 <alltraps>
...
801058c0:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801058c5:	e9 0a f5 ff ff       	jmp    80104dd4 <alltraps>
...
801058cc:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801058d1:	e9 fe f4 ff ff       	jmp    80104dd4 <alltraps>
...
801058d8:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801058dd:	e9 f2 f4 ff ff       	jmp    80104dd4 <alltraps>
...
801058e4:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801058e9:	e9 e6 f4 ff ff       	jmp    80104dd4 <alltraps>
...
801058f0:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801058f5:	e9 da f4 ff ff       	jmp    80104dd4 <alltraps>
...
801058fc:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80105901:	e9 ce f4 ff ff       	jmp    80104dd4 <alltraps>
...
80105908:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
8010590d:	e9 c2 f4 ff ff       	jmp    80104dd4 <alltraps>
...
80105914:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80105919:	e9 b6 f4 ff ff       	jmp    80104dd4 <alltraps>
...
80105920:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80105925:	e9 aa f4 ff ff       	jmp    80104dd4 <alltraps>
...
8010592c:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80105931:	e9 9e f4 ff ff       	jmp    80104dd4 <alltraps>
...
80105938:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
8010593d:	e9 92 f4 ff ff       	jmp    80104dd4 <alltraps>
...
80105944:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80105949:	e9 86 f4 ff ff       	jmp    80104dd4 <alltraps>
...
80105950:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80105955:	e9 7a f4 ff ff       	jmp    80104dd4 <alltraps>
...
8010595c:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80105961:	e9 6e f4 ff ff       	jmp    80104dd4 <alltraps>
...
80105968:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
8010596d:	e9 62 f4 ff ff       	jmp    80104dd4 <alltraps>
...
80105974:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80105979:	e9 56 f4 ff ff       	jmp    80104dd4 <alltraps>
...
80105980:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80105985:	e9 4a f4 ff ff       	jmp    80104dd4 <alltraps>
...
8010598c:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80105991:	e9 3e f4 ff ff       	jmp    80104dd4 <alltraps>
...
80105998:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
8010599d:	e9 32 f4 ff ff       	jmp    80104dd4 <alltraps>
...
801059a4:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801059a9:	e9 26 f4 ff ff       	jmp    80104dd4 <alltraps>
...
801059b0:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801059b5:	e9 1a f4 ff ff       	jmp    80104dd4 <alltraps>
...
801059bc:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801059c1:	e9 0e f4 ff ff       	jmp    80104dd4 <alltraps>
...
801059c8:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801059cd:	e9 02 f4 ff ff       	jmp    80104dd4 <alltraps>
...
801059d4:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801059d9:	e9 f6 f3 ff ff       	jmp    80104dd4 <alltraps>
...
801059e0:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801059e5:	e9 ea f3 ff ff       	jmp    80104dd4 <alltraps>
...
801059ec:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801059f1:	e9 de f3 ff ff       	jmp    80104dd4 <alltraps>
...
801059f8:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801059fd:	e9 d2 f3 ff ff       	jmp    80104dd4 <alltraps>
...
80105a04:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80105a09:	e9 c6 f3 ff ff       	jmp    80104dd4 <alltraps>
...
80105a10:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80105a15:	e9 ba f3 ff ff       	jmp    80104dd4 <alltraps>
...
80105a1c:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80105a21:	e9 ae f3 ff ff       	jmp    80104dd4 <alltraps>
...
80105a28:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80105a2d:	e9 a2 f3 ff ff       	jmp    80104dd4 <alltraps>
...
80105a34:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80105a39:	e9 96 f3 ff ff       	jmp    80104dd4 <alltraps>
...
80105a40:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80105a45:	e9 8a f3 ff ff       	jmp    80104dd4 <alltraps>
...
80105a4c:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80105a51:	e9 7e f3 ff ff       	jmp    80104dd4 <alltraps>
...
80105a58:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80105a5d:	e9 72 f3 ff ff       	jmp    80104dd4 <alltraps>
...
80105a64:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80105a69:	e9 66 f3 ff ff       	jmp    80104dd4 <alltraps>
...
80105a70:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80105a75:	e9 5a f3 ff ff       	jmp    80104dd4 <alltraps>
...
80105a7c:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80105a81:	e9 4e f3 ff ff       	jmp    80104dd4 <alltraps>
...
80105a88:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80105a8d:	e9 42 f3 ff ff       	jmp    80104dd4 <alltraps>
...
80105a94:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80105a99:	e9 36 f3 ff ff       	jmp    80104dd4 <alltraps>
...
80105aa0:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80105aa5:	e9 2a f3 ff ff       	jmp    80104dd4 <alltraps>
...
80105aac:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80105ab1:	e9 1e f3 ff ff       	jmp    80104dd4 <alltraps>
...
80105ab8:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80105abd:	e9 12 f3 ff ff       	jmp    80104dd4 <alltraps>
...
80105ac4:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80105ac9:	e9 06 f3 ff ff       	jmp    80104dd4 <alltraps>
...
80105ad0:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80105ad5:	e9 fa f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105adc:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80105ae1:	e9 ee f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105ae8:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80105aed:	e9 e2 f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105af4:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80105af9:	e9 d6 f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105b00:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80105b05:	e9 ca f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105b0c:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80105b11:	e9 be f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105b18:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80105b1d:	e9 b2 f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105b24:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80105b29:	e9 a6 f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105b30:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80105b35:	e9 9a f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105b3c:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80105b41:	e9 8e f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105b48:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80105b4d:	e9 82 f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105b54:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80105b59:	e9 76 f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105b60:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80105b65:	e9 6a f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105b6c:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80105b71:	e9 5e f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105b78:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80105b7d:	e9 52 f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105b84:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80105b89:	e9 46 f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105b90:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80105b95:	e9 3a f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105b9c:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80105ba1:	e9 2e f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105ba8:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80105bad:	e9 22 f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105bb4:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80105bb9:	e9 16 f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105bc0:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80105bc5:	e9 0a f2 ff ff       	jmp    80104dd4 <alltraps>
...
80105bcc:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80105bd1:	e9 fe f1 ff ff       	jmp    80104dd4 <alltraps>
...
80105bd8:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80105bdd:	e9 f2 f1 ff ff       	jmp    80104dd4 <alltraps>
...
80105be4:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80105be9:	e9 e6 f1 ff ff       	jmp    80104dd4 <alltraps>
...
80105bf0:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80105bf5:	e9 da f1 ff ff       	jmp    80104dd4 <alltraps>
...
80105bfc:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80105c01:	e9 ce f1 ff ff       	jmp    80104dd4 <alltraps>
...
80105c08:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80105c0d:	e9 c2 f1 ff ff       	jmp    80104dd4 <alltraps>
...
80105c14:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80105c19:	e9 b6 f1 ff ff       	jmp    80104dd4 <alltraps>
...
80105c20:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80105c25:	e9 aa f1 ff ff       	jmp    80104dd4 <alltraps>
...
80105c2c:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80105c31:	e9 9e f1 ff ff       	jmp    80104dd4 <alltraps>
...
80105c38:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80105c3d:	e9 92 f1 ff ff       	jmp    80104dd4 <alltraps>
...
80105c44:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80105c49:	e9 86 f1 ff ff       	jmp    80104dd4 <alltraps>
...
80105c50:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80105c55:	e9 7a f1 ff ff       	jmp    80104dd4 <alltraps>
...
80105c5c:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80105c61:	e9 6e f1 ff ff       	jmp    80104dd4 <alltraps>
...
80105c68:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80105c6d:	e9 62 f1 ff ff       	jmp    80104dd4 <alltraps>
	...
...
80105c7d:	89 d3                	mov    %edx,%ebx
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80105c7f:	c1 ea 16             	shr    $0x16,%edx
80105c82:	8d 3c 90             	lea    (%eax,%edx,4),%edi
  if(*pde & PTE_P){
80105c85:	8b 37                	mov    (%edi),%esi
80105c87:	f7 c6 01 00 00 00    	test   $0x1,%esi
80105c8d:	74 21                	je     80105cb0 <walkpgdir+0x3c>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80105c8f:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80105c95:	81 c6 00 00 00 80    	add    $0x80000000,%esi
  ...
  return &pgtab[PTX(va)];
80105c9b:	c1 eb 0a             	shr    $0xa,%ebx
80105c9e:	81 e3 fc 0f 00 00    	and    $0xffc,%ebx
80105ca4:	8d 04 1e             	lea    (%esi,%ebx,1),%eax
}
80105ca7:	83 c4 1c             	add    $0x1c,%esp
80105caa:	5b                   	pop    %ebx
80105cab:	5e                   	pop    %esi
80105cac:	5f                   	pop    %edi
80105cad:	5d                   	pop    %ebp
...
80105cb0:	85 c9                	test   %ecx,%ecx
80105cb2:	74 30                	je     80105ce4 <walkpgdir+0x70>
80105cb4:	e8 23 c5 ff ff       	call   801021dc <kalloc>
80105cb9:	89 c6                	mov    %eax,%esi
80105cbb:	85 c0                	test   %eax,%eax
80105cbd:	74 25                	je     80105ce4 <walkpgdir+0x70>
      return 0;
    // Make sure all those PTE_P bits are zero.
    memset(pgtab, 0, PGSIZE);
80105cbf:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80105cc6:	00 
80105cc7:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105cce:	00 
80105ccf:	89 04 24             	mov    %eax,(%esp)
80105cd2:	e8 d5 e0 ff ff       	call   80103dac <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80105cd7:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80105cdd:	83 c8 07             	or     $0x7,%eax
80105ce0:	89 07                	mov    %eax,(%edi)
80105ce2:	eb b7                	jmp    80105c9b <walkpgdir+0x27>
  pde = &pgdir[PDX(va)];
  if(*pde & PTE_P){
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
  } else {
...
80105ce6:	83 c4 1c             	add    $0x1c,%esp
80105ce9:	5b                   	pop    %ebx
80105cea:	5e                   	pop    %esi
80105ceb:	5f                   	pop    %edi
80105cec:	5d                   	pop    %ebp
...
80105cf6:	83 ec 2c             	sub    $0x2c,%esp
80105cf9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105cfc:	8b 75 08             	mov    0x8(%ebp),%esi
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
80105cff:	89 d3                	mov    %edx,%ebx
80105d01:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80105d07:	8d 7c 0a ff          	lea    -0x1(%edx,%ecx,1),%edi
80105d0b:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
80105d11:	83 4d 0c 01          	orl    $0x1,0xc(%ebp)
80105d15:	eb 1d                	jmp    80105d34 <mappages+0x44>
80105d17:	90                   	nop
  a = (char*)PGROUNDDOWN((uint)va);
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
      return -1;
    if(*pte & PTE_P)
80105d18:	f6 00 01             	testb  $0x1,(%eax)
80105d1b:	75 41                	jne    80105d5e <mappages+0x6e>
      panic("remap");
    *pte = pa | perm | PTE_P;
80105d1d:	8b 55 0c             	mov    0xc(%ebp),%edx
80105d20:	09 f2                	or     %esi,%edx
80105d22:	89 10                	mov    %edx,(%eax)
    if(a == last)
80105d24:	39 fb                	cmp    %edi,%ebx
80105d26:	74 2c                	je     80105d54 <mappages+0x64>
      break;
    a += PGSIZE;
80105d28:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    pa += PGSIZE;
80105d2e:	81 c6 00 10 00 00    	add    $0x1000,%esi
  pte_t *pte;
  ...
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105d34:	b9 01 00 00 00       	mov    $0x1,%ecx
80105d39:	89 da                	mov    %ebx,%edx
80105d3b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105d3e:	e8 31 ff ff ff       	call   80105c74 <walkpgdir>
80105d43:	85 c0                	test   %eax,%eax
80105d45:	75 d1                	jne    80105d18 <mappages+0x28>
      return -1;
...
80105d4c:	83 c4 2c             	add    $0x2c,%esp
80105d4f:	5b                   	pop    %ebx
80105d50:	5e                   	pop    %esi
80105d51:	5f                   	pop    %edi
80105d52:	5d                   	pop    %ebp
...
80105d5d:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
80105d5e:	c7 04 24 cc 6d 10 80 	movl   $0x80106dcc,(%esp)
80105d65:	e8 b2 a5 ff ff       	call   8010031c <panic>
...
80105d6f:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
80105d72:	e8 05 d5 ff ff       	call   8010327c <cpuid>
80105d77:	8d 14 80             	lea    (%eax,%eax,4),%edx
80105d7a:	8d 04 50             	lea    (%eax,%edx,2),%eax
80105d7d:	c1 e0 04             	shl    $0x4,%eax
80105d80:	05 80 17 11 80       	add    $0x80111780,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80105d85:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80105d8b:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
80105d91:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
80105d95:	c6 40 7d 9a          	movb   $0x9a,0x7d(%eax)
80105d99:	c6 40 7e cf          	movb   $0xcf,0x7e(%eax)
80105d9d:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80105da1:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
80105da8:	ff ff 
80105daa:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80105db1:	00 00 
80105db3:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80105dba:	c6 80 85 00 00 00 92 	movb   $0x92,0x85(%eax)
80105dc1:	c6 80 86 00 00 00 cf 	movb   $0xcf,0x86(%eax)
80105dc8:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80105dcf:	66 c7 80 88 00 00 00 	movw   $0xffff,0x88(%eax)
80105dd6:	ff ff 
80105dd8:	66 c7 80 8a 00 00 00 	movw   $0x0,0x8a(%eax)
80105ddf:	00 00 
80105de1:	c6 80 8c 00 00 00 00 	movb   $0x0,0x8c(%eax)
80105de8:	c6 80 8d 00 00 00 fa 	movb   $0xfa,0x8d(%eax)
80105def:	c6 80 8e 00 00 00 cf 	movb   $0xcf,0x8e(%eax)
80105df6:	c6 80 8f 00 00 00 00 	movb   $0x0,0x8f(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80105dfd:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80105e04:	ff ff 
80105e06:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80105e0d:	00 00 
80105e0f:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
80105e16:	c6 80 95 00 00 00 f2 	movb   $0xf2,0x95(%eax)
80105e1d:	c6 80 96 00 00 00 cf 	movb   $0xcf,0x96(%eax)
80105e24:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  lgdt(c->gdt, sizeof(c->gdt));
80105e2b:	83 c0 70             	add    $0x70,%eax
static inline void
lgdt(struct segdesc *p, int size)
{
  ...
  pd[0] = size-1;
80105e2e:	66 c7 45 f2 2f 00    	movw   $0x2f,-0xe(%ebp)
  pd[1] = (uint)p;
80105e34:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
80105e38:	c1 e8 10             	shr    $0x10,%eax
80105e3b:	66 89 45 f6          	mov    %ax,-0xa(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80105e3f:	8d 45 f2             	lea    -0xe(%ebp),%eax
80105e42:	0f 01 10             	lgdtl  (%eax)
}
80105e45:	c9                   	leave  
80105e46:	c3                   	ret    
80105e47:	90                   	nop
...
80105e4b:	a1 a4 44 11 80       	mov    0x801144a4,%eax
80105e50:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
80105e60:	56                   	push   %esi
80105e61:	53                   	push   %ebx
80105e62:	83 ec 2c             	sub    $0x2c,%esp
80105e65:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
80105e68:	85 f6                	test   %esi,%esi
80105e6a:	0f 84 c4 00 00 00    	je     80105f34 <switchuvm+0xd8>
    panic("switchuvm: no process");
  if(p->kstack == 0)
80105e70:	8b 56 08             	mov    0x8(%esi),%edx
80105e73:	85 d2                	test   %edx,%edx
80105e75:	0f 84 d1 00 00 00    	je     80105f4c <switchuvm+0xf0>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
80105e7b:	8b 46 04             	mov    0x4(%esi),%eax
80105e7e:	85 c0                	test   %eax,%eax
80105e80:	0f 84 ba 00 00 00    	je     80105f40 <switchuvm+0xe4>
    panic("switchuvm: no pgdir");

  pushcli();
80105e86:	e8 a1 dd ff ff       	call   80103c2c <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80105e8b:	e8 78 d3 ff ff       	call   80103208 <mycpu>
80105e90:	89 c3                	mov    %eax,%ebx
80105e92:	e8 71 d3 ff ff       	call   80103208 <mycpu>
80105e97:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105e9a:	e8 69 d3 ff ff       	call   80103208 <mycpu>
80105e9f:	89 c7                	mov    %eax,%edi
80105ea1:	e8 62 d3 ff ff       	call   80103208 <mycpu>
80105ea6:	66 c7 83 98 00 00 00 	movw   $0x67,0x98(%ebx)
80105ead:	67 00 
80105eaf:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80105eb2:	83 c2 08             	add    $0x8,%edx
80105eb5:	66 89 93 9a 00 00 00 	mov    %dx,0x9a(%ebx)
80105ebc:	8d 57 08             	lea    0x8(%edi),%edx
80105ebf:	c1 ea 10             	shr    $0x10,%edx
80105ec2:	88 93 9c 00 00 00    	mov    %dl,0x9c(%ebx)
80105ec8:	c6 83 9d 00 00 00 99 	movb   $0x99,0x9d(%ebx)
80105ecf:	c6 83 9e 00 00 00 40 	movb   $0x40,0x9e(%ebx)
80105ed6:	83 c0 08             	add    $0x8,%eax
80105ed9:	c1 e8 18             	shr    $0x18,%eax
80105edc:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80105ee2:	e8 21 d3 ff ff       	call   80103208 <mycpu>
80105ee7:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80105eee:	e8 15 d3 ff ff       	call   80103208 <mycpu>
80105ef3:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80105ef9:	e8 0a d3 ff ff       	call   80103208 <mycpu>
80105efe:	8b 56 08             	mov    0x8(%esi),%edx
80105f01:	81 c2 00 10 00 00    	add    $0x1000,%edx
80105f07:	89 50 0c             	mov    %edx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80105f0a:	e8 f9 d2 ff ff       	call   80103208 <mycpu>
80105f0f:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
}
...
80105f15:	b8 28 00 00 00       	mov    $0x28,%eax
80105f1a:	0f 00 d8             	ltr    %ax
  ltr(SEG_TSS << 3);
  lcr3(V2P(p->pgdir));  // switch to process's address space
80105f1d:	8b 46 04             	mov    0x4(%esi),%eax
80105f20:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
{
  asm volatile("movl %0,%%cr3" : : "r" (val));
80105f25:	0f 22 d8             	mov    %eax,%cr3
  popcli();
}
80105f28:	83 c4 2c             	add    $0x2c,%esp
80105f2b:	5b                   	pop    %ebx
80105f2c:	5e                   	pop    %esi
80105f2d:	5f                   	pop    %edi
80105f2e:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80105f2f:	e9 30 dd ff ff       	jmp    80103c64 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
80105f34:	c7 04 24 d2 6d 10 80 	movl   $0x80106dd2,(%esp)
80105f3b:	e8 dc a3 ff ff       	call   8010031c <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
80105f40:	c7 04 24 fd 6d 10 80 	movl   $0x80106dfd,(%esp)
80105f47:	e8 d0 a3 ff ff       	call   8010031c <panic>
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
80105f4c:	c7 04 24 e8 6d 10 80 	movl   $0x80106de8,(%esp)
80105f53:	e8 c4 a3 ff ff       	call   8010031c <panic>
...
80105f5e:	83 ec 2c             	sub    $0x2c,%esp
80105f61:	8b 45 08             	mov    0x8(%ebp),%eax
80105f64:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105f67:	8b 7d 0c             	mov    0xc(%ebp),%edi
80105f6a:	8b 75 10             	mov    0x10(%ebp),%esi
  char *mem;

  if(sz >= PGSIZE)
80105f6d:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80105f73:	77 54                	ja     80105fc9 <inituvm+0x71>
    panic("inituvm: more than a page");
  mem = kalloc();
80105f75:	e8 62 c2 ff ff       	call   801021dc <kalloc>
80105f7a:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80105f7c:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80105f83:	00 
80105f84:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105f8b:	00 
80105f8c:	89 04 24             	mov    %eax,(%esp)
80105f8f:	e8 18 de ff ff       	call   80103dac <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80105f94:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80105f9b:	00 
80105f9c:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80105fa2:	89 04 24             	mov    %eax,(%esp)
80105fa5:	b9 00 10 00 00       	mov    $0x1000,%ecx
80105faa:	31 d2                	xor    %edx,%edx
80105fac:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105faf:	e8 3c fd ff ff       	call   80105cf0 <mappages>
  memmove(mem, init, sz);
80105fb4:	89 75 10             	mov    %esi,0x10(%ebp)
80105fb7:	89 7d 0c             	mov    %edi,0xc(%ebp)
80105fba:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
80105fbd:	83 c4 2c             	add    $0x2c,%esp
80105fc0:	5b                   	pop    %ebx
80105fc1:	5e                   	pop    %esi
80105fc2:	5f                   	pop    %edi
80105fc3:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80105fc4:	e9 73 de ff ff       	jmp    80103e3c <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
80105fc9:	c7 04 24 11 6e 10 80 	movl   $0x80106e11,(%esp)
80105fd0:	e8 47 a3 ff ff       	call   8010031c <panic>
...
80105fe1:	8b 7d 0c             	mov    0xc(%ebp),%edi
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80105fe4:	f7 c7 ff 0f 00 00    	test   $0xfff,%edi
80105fea:	0f 85 9d 00 00 00    	jne    8010608d <loaduvm+0xb5>
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
80105ff0:	8b 4d 18             	mov    0x18(%ebp),%ecx
80105ff3:	85 c9                	test   %ecx,%ecx
80105ff5:	74 71                	je     80106068 <loaduvm+0x90>
80105ff7:	8b 75 18             	mov    0x18(%ebp),%esi
80105ffa:	31 db                	xor    %ebx,%ebx
80105ffc:	eb 40                	jmp    8010603e <loaduvm+0x66>
...
80106002:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106006:	8b 4d 14             	mov    0x14(%ebp),%ecx
80106009:	01 d9                	add    %ebx,%ecx
...
8010601e:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80106021:	e8 5e b7 ff ff       	call   80101784 <readi>
80106026:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106029:	39 d0                	cmp    %edx,%eax
8010602b:	75 47                	jne    80106074 <loaduvm+0x9c>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
8010602d:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106033:	81 ee 00 10 00 00    	sub    $0x1000,%esi
80106039:	39 5d 18             	cmp    %ebx,0x18(%ebp)
8010603c:	76 2a                	jbe    80106068 <loaduvm+0x90>
}
...
int
loaduvm(pde_t *pgdir, char *addr, struct inode *ip, uint offset, uint sz)
8010603e:	8d 14 1f             	lea    (%edi,%ebx,1),%edx
  pte_t *pte;
...
80106046:	e8 29 fc ff ff       	call   80105c74 <walkpgdir>
8010604b:	85 c0                	test   %eax,%eax
8010604d:	74 32                	je     80106081 <loaduvm+0xa9>
      panic("loaduvm: address should exist");
    pa = PTE_ADDR(*pte);
8010604f:	8b 00                	mov    (%eax),%eax
80106051:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
80106056:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
8010605c:	76 a2                	jbe    80106000 <loaduvm+0x28>
      n = sz - i;
    else
      n = PGSIZE;
8010605e:	ba 00 10 00 00       	mov    $0x1000,%edx
80106063:	eb 9d                	jmp    80106002 <loaduvm+0x2a>
80106065:	8d 76 00             	lea    0x0(%esi),%esi
    if(readi(ip, P2V(pa), offset+i, n) != n)
      return -1;
  }
  return 0;
80106068:	31 c0                	xor    %eax,%eax
}
8010606a:	83 c4 2c             	add    $0x2c,%esp
8010606d:	5b                   	pop    %ebx
8010606e:	5e                   	pop    %esi
8010606f:	5f                   	pop    %edi
80106070:	5d                   	pop    %ebp
80106071:	c3                   	ret    
80106072:	66 90                	xchg   %ax,%ax
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
...
80106079:	83 c4 2c             	add    $0x2c,%esp
8010607c:	5b                   	pop    %ebx
8010607d:	5e                   	pop    %esi
8010607e:	5f                   	pop    %edi
8010607f:	5d                   	pop    %ebp
80106080:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
80106081:	c7 04 24 2b 6e 10 80 	movl   $0x80106e2b,(%esp)
80106088:	e8 8f a2 ff ff       	call   8010031c <panic>
{
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
8010608d:	c7 04 24 cc 6e 10 80 	movl   $0x80106ecc,(%esp)
80106094:	e8 83 a2 ff ff       	call   8010031c <panic>
80106099:	8d 76 00             	lea    0x0(%esi),%esi
...
8010609f:	57                   	push   %edi
801060a0:	56                   	push   %esi
801060a1:	53                   	push   %ebx
801060a2:	83 ec 2c             	sub    $0x2c,%esp
801060a5:	8b 7d 08             	mov    0x8(%ebp),%edi
801060a8:	8b 75 0c             	mov    0xc(%ebp),%esi
  pte_t *pte;
  uint a, pa;

  if(newsz >= oldsz)
801060ab:	39 75 10             	cmp    %esi,0x10(%ebp)
801060ae:	73 7c                	jae    8010612c <deallocuvm+0x90>
    return oldsz;

  a = PGROUNDUP(newsz);
801060b0:	8b 5d 10             	mov    0x10(%ebp),%ebx
801060b3:	81 c3 ff 0f 00 00    	add    $0xfff,%ebx
801060b9:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
801060bf:	39 de                	cmp    %ebx,%esi
801060c1:	77 38                	ja     801060fb <deallocuvm+0x5f>
801060c3:	eb 5b                	jmp    80106120 <deallocuvm+0x84>
801060c5:	8d 76 00             	lea    0x0(%esi),%esi
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
    else if((*pte & PTE_P) != 0){
801060c8:	8b 10                	mov    (%eax),%edx
801060ca:	f6 c2 01             	test   $0x1,%dl
801060cd:	74 22                	je     801060f1 <deallocuvm+0x55>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
801060cf:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
801060d5:	74 5f                	je     80106136 <deallocuvm+0x9a>
        panic("kfree");
      char *v = P2V(pa);
801060d7:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
801060dd:	89 14 24             	mov    %edx,(%esp)
801060e0:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801060e3:	e8 b0 bf ff ff       	call   80102098 <kfree>
      *pte = 0;
801060e8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801060eb:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  a = PGROUNDUP(newsz);
  for(; a  < oldsz; a += PGSIZE){
801060f1:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801060f7:	39 de                	cmp    %ebx,%esi
801060f9:	76 25                	jbe    80106120 <deallocuvm+0x84>
    pte = walkpgdir(pgdir, (char*)a, 0);
801060fb:	31 c9                	xor    %ecx,%ecx
801060fd:	89 da                	mov    %ebx,%edx
801060ff:	89 f8                	mov    %edi,%eax
80106101:	e8 6e fb ff ff       	call   80105c74 <walkpgdir>
    if(!pte)
80106106:	85 c0                	test   %eax,%eax
80106108:	75 be                	jne    801060c8 <deallocuvm+0x2c>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
8010610a:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
80106110:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
...
8010611c:	39 de                	cmp    %ebx,%esi
8010611e:	77 db                	ja     801060fb <deallocuvm+0x5f>
      char *v = P2V(pa);
      kfree(v);
      *pte = 0;
    }
...
80106123:	83 c4 2c             	add    $0x2c,%esp
80106126:	5b                   	pop    %ebx
80106127:	5e                   	pop    %esi
80106128:	5f                   	pop    %edi
80106129:	5d                   	pop    %ebp
...
8010612e:	83 c4 2c             	add    $0x2c,%esp
80106131:	5b                   	pop    %ebx
80106132:	5e                   	pop    %esi
80106133:	5f                   	pop    %edi
80106134:	5d                   	pop    %ebp
80106135:	c3                   	ret    
    if(!pte)
      ...
      if(pa == 0)
        panic("kfree");
80106136:	c7 04 24 86 67 10 80 	movl   $0x80106786,(%esp)
8010613d:	e8 da a1 ff ff       	call   8010031c <panic>
...
8010614a:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if(newsz >= KERNBASE)
8010614d:	8b 7d 10             	mov    0x10(%ebp),%edi
80106150:	85 ff                	test   %edi,%edi
80106152:	0f 88 b8 00 00 00    	js     80106210 <allocuvm+0xcc>
    return 0;
  if(newsz < oldsz)
80106158:	3b 7d 0c             	cmp    0xc(%ebp),%edi
8010615b:	0f 82 9f 00 00 00    	jb     80106200 <allocuvm+0xbc>
    return oldsz;

  a = PGROUNDUP(oldsz);
80106161:	8b 75 0c             	mov    0xc(%ebp),%esi
80106164:	81 c6 ff 0f 00 00    	add    $0xfff,%esi
8010616a:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80106170:	39 75 10             	cmp    %esi,0x10(%ebp)
80106173:	77 4e                	ja     801061c3 <allocuvm+0x7f>
80106175:	e9 89 00 00 00       	jmp    80106203 <allocuvm+0xbf>
8010617a:	66 90                	xchg   %ax,%ax
    ...
    memset(mem, 0, PGSIZE);
8010617c:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106183:	00 
80106184:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010618b:	00 
8010618c:	89 04 24             	mov    %eax,(%esp)
8010618f:	e8 18 dc ff ff       	call   80103dac <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106194:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
8010619b:	00 
8010619c:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801061a2:	89 04 24             	mov    %eax,(%esp)
801061a5:	b9 00 10 00 00       	mov    $0x1000,%ecx
801061aa:	89 f2                	mov    %esi,%edx
801061ac:	8b 45 08             	mov    0x8(%ebp),%eax
801061af:	e8 3c fb ff ff       	call   80105cf0 <mappages>
801061b4:	85 c0                	test   %eax,%eax
801061b6:	78 64                	js     8010621c <allocuvm+0xd8>
    return 0;
  if(newsz < oldsz)
    return oldsz;
  ...
  a = PGROUNDUP(oldsz);
  for(; a < newsz; a += PGSIZE){
801061b8:	81 c6 00 10 00 00    	add    $0x1000,%esi
801061be:	39 75 10             	cmp    %esi,0x10(%ebp)
801061c1:	76 40                	jbe    80106203 <allocuvm+0xbf>
    mem = kalloc();
801061c3:	e8 14 c0 ff ff       	call   801021dc <kalloc>
801061c8:	89 c3                	mov    %eax,%ebx
    if(mem == 0){
801061ca:	85 c0                	test   %eax,%eax
801061cc:	75 ae                	jne    8010617c <allocuvm+0x38>
      cprintf("allocuvm out of memory\n");
801061ce:	c7 04 24 49 6e 10 80 	movl   $0x80106e49,(%esp)
801061d5:	e8 e2 a3 ff ff       	call   801005bc <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
...
801061ee:	e8 a9 fe ff ff       	call   8010609c <deallocuvm>
      return 0;
801061f3:	31 ff                	xor    %edi,%edi
      kfree(mem);
      return 0;
    }
  }
...
801061f5:	89 f8                	mov    %edi,%eax
801061f7:	83 c4 1c             	add    $0x1c,%esp
801061fa:	5b                   	pop    %ebx
801061fb:	5e                   	pop    %esi
801061fc:	5f                   	pop    %edi
801061fd:	5d                   	pop    %ebp
...
801061ff:	90                   	nop
  ...
  if(newsz < oldsz)
    return oldsz;
80106200:	8b 7d 0c             	mov    0xc(%ebp),%edi
      kfree(mem);
      return 0;
    }
  }
...
80106203:	89 f8                	mov    %edi,%eax
80106205:	83 c4 1c             	add    $0x1c,%esp
80106208:	5b                   	pop    %ebx
80106209:	5e                   	pop    %esi
8010620a:	5f                   	pop    %edi
8010620b:	5d                   	pop    %ebp
...
80106212:	89 f8                	mov    %edi,%eax
80106214:	83 c4 1c             	add    $0x1c,%esp
80106217:	5b                   	pop    %ebx
80106218:	5e                   	pop    %esi
80106219:	5f                   	pop    %edi
8010621a:	5d                   	pop    %ebp
...
8010621c:	c7 04 24 61 6e 10 80 	movl   $0x80106e61,(%esp)
80106223:	e8 94 a3 ff ff       	call   801005bc <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80106228:	8b 45 0c             	mov    0xc(%ebp),%eax
8010622b:	89 44 24 08          	mov    %eax,0x8(%esp)
8010622f:	8b 45 10             	mov    0x10(%ebp),%eax
80106232:	89 44 24 04          	mov    %eax,0x4(%esp)
80106236:	8b 45 08             	mov    0x8(%ebp),%eax
80106239:	89 04 24             	mov    %eax,(%esp)
8010623c:	e8 5b fe ff ff       	call   8010609c <deallocuvm>
      kfree(mem);
80106241:	89 1c 24             	mov    %ebx,(%esp)
80106244:	e8 4f be ff ff       	call   80102098 <kfree>
      return 0;
80106249:	31 ff                	xor    %edi,%edi
    }
  }
  return newsz;
}
8010624b:	89 f8                	mov    %edi,%eax
8010624d:	83 c4 1c             	add    $0x1c,%esp
80106250:	5b                   	pop    %ebx
80106251:	5e                   	pop    %esi
80106252:	5f                   	pop    %edi
80106253:	5d                   	pop    %ebp
...
80106260:	8b 5d 08             	mov    0x8(%ebp),%ebx
  uint i;

  if(pgdir == 0)
80106263:	85 db                	test   %ebx,%ebx
80106265:	74 56                	je     801062bd <freevm+0x65>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
80106267:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010626e:	00 
8010626f:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
80106276:	80 
80106277:	89 1c 24             	mov    %ebx,(%esp)
8010627a:	e8 1d fe ff ff       	call   8010609c <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
8010627f:	31 f6                	xor    %esi,%esi
80106281:	eb 0a                	jmp    8010628d <freevm+0x35>
80106283:	90                   	nop
80106284:	46                   	inc    %esi
80106285:	81 fe 00 04 00 00    	cmp    $0x400,%esi
8010628b:	74 22                	je     801062af <freevm+0x57>
    if(pgdir[i] & PTE_P){
8010628d:	8b 04 b3             	mov    (%ebx,%esi,4),%eax
80106290:	a8 01                	test   $0x1,%al
80106292:	74 f0                	je     80106284 <freevm+0x2c>
      char * v = P2V(PTE_ADDR(pgdir[i]));
80106294:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106299:	05 00 00 00 80       	add    $0x80000000,%eax
      kfree(v);
8010629e:	89 04 24             	mov    %eax,(%esp)
801062a1:	e8 f2 bd ff ff       	call   80102098 <kfree>
  uint i;
  ...
  for(i = 0; i < NPDENTRIES; i++){
801062a6:	46                   	inc    %esi
801062a7:	81 fe 00 04 00 00    	cmp    $0x400,%esi
801062ad:	75 de                	jne    8010628d <freevm+0x35>
    if(pgdir[i] & PTE_P){
      char * v = P2V(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
  ...
  kfree((char*)pgdir);
801062af:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
...
801062b7:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
801062b8:	e9 db bd ff ff       	jmp    80102098 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
801062bd:	c7 04 24 7d 6e 10 80 	movl   $0x80106e7d,(%esp)
801062c4:	e8 53 a0 ff ff       	call   8010031c <panic>
801062c9:	8d 76 00             	lea    0x0(%esi),%esi
...
801062d4:	e8 03 bf ff ff       	call   801021dc <kalloc>
801062d9:	89 c6                	mov    %eax,%esi
801062db:	85 c0                	test   %eax,%eax
801062dd:	74 47                	je     80106326 <setupkvm+0x5a>
    return 0;
  memset(pgdir, 0, PGSIZE);
801062df:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801062e6:	00 
801062e7:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801062ee:	00 
801062ef:	89 04 24             	mov    %eax,(%esp)
801062f2:	e8 b5 da ff ff       	call   80103dac <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801062f7:	bb 20 94 10 80       	mov    $0x80109420,%ebx
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
801062fc:	8b 43 04             	mov    0x4(%ebx),%eax
801062ff:	8b 4b 08             	mov    0x8(%ebx),%ecx
80106302:	29 c1                	sub    %eax,%ecx
80106304:	8b 53 0c             	mov    0xc(%ebx),%edx
80106307:	89 54 24 04          	mov    %edx,0x4(%esp)
8010630b:	89 04 24             	mov    %eax,(%esp)
8010630e:	8b 13                	mov    (%ebx),%edx
80106310:	89 f0                	mov    %esi,%eax
80106312:	e8 d9 f9 ff ff       	call   80105cf0 <mappages>
80106317:	85 c0                	test   %eax,%eax
80106319:	78 15                	js     80106330 <setupkvm+0x64>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010631b:	83 c3 10             	add    $0x10,%ebx
8010631e:	81 fb 60 94 10 80    	cmp    $0x80109460,%ebx
80106324:	72 d6                	jb     801062fc <setupkvm+0x30>
...
8010632f:	90                   	nop
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
                (uint)k->phys_start, k->perm) < 0) {
      freevm(pgdir);
80106330:	89 34 24             	mov    %esi,(%esp)
80106333:	e8 20 ff ff ff       	call   80106258 <freevm>
      return 0;
80106338:	31 f6                	xor    %esi,%esi
    }
  return pgdir;
}
8010633a:	89 f0                	mov    %esi,%eax
...
80106347:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
8010634a:	e8 7d ff ff ff       	call   801062cc <setupkvm>
8010634f:	a3 a4 44 11 80       	mov    %eax,0x801144a4
// Switch h/w page table register to the kernel-only page table,
// for when no process is running.
void
switchkvm(void)
...
80106368:	8b 55 0c             	mov    0xc(%ebp),%edx
8010636b:	8b 45 08             	mov    0x8(%ebp),%eax
8010636e:	e8 01 f9 ff ff       	call   80105c74 <walkpgdir>
  if(pte == 0)
80106373:	85 c0                	test   %eax,%eax
80106375:	74 05                	je     8010637c <clearpteu+0x1c>
    panic("clearpteu");
  *pte &= ~PTE_U;
80106377:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
8010637a:	c9                   	leave  
8010637b:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
8010637c:	c7 04 24 8e 6e 10 80 	movl   $0x80106e8e,(%esp)
80106383:	e8 94 9f ff ff       	call   8010031c <panic>
...
8010638e:	83 ec 2c             	sub    $0x2c,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
80106391:	e8 36 ff ff ff       	call   801062cc <setupkvm>
80106396:	89 c7                	mov    %eax,%edi
80106398:	85 c0                	test   %eax,%eax
8010639a:	0f 84 91 00 00 00    	je     80106431 <copyuvm+0xa9>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
801063a0:	8b 5d 0c             	mov    0xc(%ebp),%ebx
801063a3:	85 db                	test   %ebx,%ebx
801063a5:	0f 84 86 00 00 00    	je     80106431 <copyuvm+0xa9>
801063ab:	31 f6                	xor    %esi,%esi
801063ad:	eb 54                	jmp    80106403 <copyuvm+0x7b>
801063af:	90                   	nop
...
801063cc:	e8 6b da ff ff       	call   80103e3c <memmove>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
...
801063d4:	25 ff 0f 00 00       	and    $0xfff,%eax
    if((mem = kalloc()) == 0)
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
801063d9:	89 44 24 04          	mov    %eax,0x4(%esp)
801063dd:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801063e3:	89 04 24             	mov    %eax,(%esp)
801063e6:	b9 00 10 00 00       	mov    $0x1000,%ecx
801063eb:	89 f2                	mov    %esi,%edx
801063ed:	89 f8                	mov    %edi,%eax
801063ef:	e8 fc f8 ff ff       	call   80105cf0 <mappages>
801063f4:	85 c0                	test   %eax,%eax
801063f6:	78 44                	js     8010643c <copyuvm+0xb4>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
801063f8:	81 c6 00 10 00 00    	add    $0x1000,%esi
801063fe:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106401:	76 2e                	jbe    80106431 <copyuvm+0xa9>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106403:	31 c9                	xor    %ecx,%ecx
80106405:	89 f2                	mov    %esi,%edx
80106407:	8b 45 08             	mov    0x8(%ebp),%eax
8010640a:	e8 65 f8 ff ff       	call   80105c74 <walkpgdir>
8010640f:	85 c0                	test   %eax,%eax
80106411:	74 3f                	je     80106452 <copyuvm+0xca>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106413:	8b 00                	mov    (%eax),%eax
80106415:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106418:	a8 01                	test   $0x1,%al
8010641a:	74 2a                	je     80106446 <copyuvm+0xbe>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
8010641c:	e8 bb bd ff ff       	call   801021dc <kalloc>
80106421:	89 c3                	mov    %eax,%ebx
80106423:	85 c0                	test   %eax,%eax
80106425:	75 89                	jne    801063b0 <copyuvm+0x28>
    }
  }
  return d;
...
bad:
  freevm(d);
80106427:	89 3c 24             	mov    %edi,(%esp)
8010642a:	e8 29 fe ff ff       	call   80106258 <freevm>
  return 0;
8010642f:	31 ff                	xor    %edi,%edi
}
80106431:	89 f8                	mov    %edi,%eax
80106433:	83 c4 2c             	add    $0x2c,%esp
80106436:	5b                   	pop    %ebx
80106437:	5e                   	pop    %esi
80106438:	5f                   	pop    %edi
80106439:	5d                   	pop    %ebp
...
8010643f:	e8 54 bc ff ff       	call   80102098 <kfree>
      goto bad;
80106444:	eb e1                	jmp    80106427 <copyuvm+0x9f>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106446:	c7 04 24 b2 6e 10 80 	movl   $0x80106eb2,(%esp)
8010644d:	e8 ca 9e ff ff       	call   8010031c <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106452:	c7 04 24 98 6e 10 80 	movl   $0x80106e98,(%esp)
80106459:	e8 be 9e ff ff       	call   8010031c <panic>
...
8010646e:	e8 01 f8 ff ff       	call   80105c74 <walkpgdir>
  if((*pte & PTE_P) == 0)
80106473:	8b 00                	mov    (%eax),%eax
80106475:	a8 01                	test   $0x1,%al
80106477:	74 13                	je     8010648c <uva2ka+0x2c>
    return 0;
  if((*pte & PTE_U) == 0)
80106479:	a8 04                	test   $0x4,%al
8010647b:	74 0f                	je     8010648c <uva2ka+0x2c>
    return 0;
  return (char*)P2V(PTE_ADDR(*pte));
8010647d:	25 00 f0 ff ff       	and    $0xfffff000,%eax
...
80106499:	8b 7d 0c             	mov    0xc(%ebp),%edi
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
8010649c:	8b 75 14             	mov    0x14(%ebp),%esi
8010649f:	85 f6                	test   %esi,%esi
801064a1:	74 69                	je     8010650c <copyout+0x7c>
801064a3:	8b 55 10             	mov    0x10(%ebp),%edx
801064a6:	89 55 e4             	mov    %edx,-0x1c(%ebp)
801064a9:	eb 38                	jmp    801064e3 <copyout+0x53>
801064ab:	90                   	nop
    ...
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
801064ac:	89 f3                	mov    %esi,%ebx
801064ae:	29 fb                	sub    %edi,%ebx
801064b0:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801064b6:	3b 5d 14             	cmp    0x14(%ebp),%ebx
801064b9:	76 03                	jbe    801064be <copyout+0x2e>
801064bb:	8b 5d 14             	mov    0x14(%ebp),%ebx
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
801064be:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801064c2:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801064c5:	89 54 24 04          	mov    %edx,0x4(%esp)
801064c9:	29 f7                	sub    %esi,%edi
801064cb:	01 c7                	add    %eax,%edi
801064cd:	89 3c 24             	mov    %edi,(%esp)
801064d0:	e8 67 d9 ff ff       	call   80103e3c <memmove>
    len -= n;
    buf += n;
801064d5:	01 5d e4             	add    %ebx,-0x1c(%ebp)
    va = va0 + PGSIZE;
801064d8:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
801064de:	29 5d 14             	sub    %ebx,0x14(%ebp)
801064e1:	74 29                	je     8010650c <copyout+0x7c>
    va0 = (uint)PGROUNDDOWN(va);
801064e3:	89 fe                	mov    %edi,%esi
801064e5:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
801064eb:	89 74 24 04          	mov    %esi,0x4(%esp)
801064ef:	8b 55 08             	mov    0x8(%ebp),%edx
801064f2:	89 14 24             	mov    %edx,(%esp)
801064f5:	e8 66 ff ff ff       	call   80106460 <uva2ka>
    if(pa0 == 0)
801064fa:	85 c0                	test   %eax,%eax
801064fc:	75 ae                	jne    801064ac <copyout+0x1c>
      return -1;
...
80106503:	83 c4 2c             	add    $0x2c,%esp
80106506:	5b                   	pop    %ebx
80106507:	5e                   	pop    %esi
80106508:	5f                   	pop    %edi
80106509:	5d                   	pop    %ebp
...
8010650b:	90                   	nop
  ...
  return 0;
8010650c:	31 c0                	xor    %eax,%eax
}
8010650e:	83 c4 2c             	add    $0x2c,%esp
80106511:	5b                   	pop    %ebx
80106512:	5e                   	pop    %esi
80106513:	5f                   	pop    %edi
80106514:	5d                   	pop    %ebp
