...
main(int argc, char *argv[])
  ...
  41:	c7 44 24 04 15 06 00 	movl   $0x615,0x4(%esp)
  48:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 324:	f7 f1                	div    %ecx
 326:	8a 92 38 06 00 00    	mov    0x638(%edx),%dl
 ...
 384:	89 45 e4             	mov    %eax,-0x1c(%ebp)
{
 ...
 494:	e9 02 ff ff ff       	jmp    39b <printf+0x2f>
        ...
        if(s == 0)
          s = "(null)";
 499:	be 31 06 00 00       	mov    $0x631,%esi
...
free(void *ap)
{
 ...
 4ac:	a1 f0 08 00 00       	mov    0x8f0,%eax
...
free(void *ap)
{
 ...
 4e7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 4e9:	a3 f0 08 00 00       	mov    %eax,0x8f0
}
 4ee:	5b                   	pop    %ebx
 4ef:	5e                   	pop    %esi
 4f0:	5f                   	pop    %edi
 ...
 513:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 515:	a3 f0 08 00 00       	mov    %eax,0x8f0
}
 51a:	5b                   	pop    %ebx
 51b:	5e                   	pop    %esi
 51c:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 532:	43                   	inc    %ebx
  if((prevp = freep) == 0){
 533:	8b 0d f0 08 00 00    	mov    0x8f0,%ecx
 ...
 55d:	76 51                	jbe    5b0 <malloc+0x90>
    ...
    if(p == freep)
 55f:	3b 05 f0 08 00 00    	cmp    0x8f0,%eax
...
morecore(uint nu)
{
 ...
 589:	e8 12 ff ff ff       	call   4a0 <free>
  return freep;
 58e:	8b 0d f0 08 00 00    	mov    0x8f0,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
...
morecore(uint nu)
{
 ...
 5bc:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 5bf:	89 0d f0 08 00 00    	mov    %ecx,0x8f0
      return (void*)(p + 1);
 ...
 5d4:	eb e9                	jmp    5bf <malloc+0x9f>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 5d6:	c7 05 f0 08 00 00 f4 	movl   $0x8f4,0x8f0
 5dd:	08 00 00 
 5e0:	c7 05 f4 08 00 00 f4 	movl   $0x8f4,0x8f4
 5e7:	08 00 00 
    base.s.size = 0;
 5ea:	c7 05 f8 08 00 00 00 	movl   $0x0,0x8f8
 5f1:	00 00 00 
 5f4:	b8 f4 08 00 00       	mov    $0x8f4,%eax
