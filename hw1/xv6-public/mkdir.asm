...
main(int argc, char *argv[])
  ...
  41:	c7 44 24 04 0d 06 00 	movl   $0x60d,0x4(%esp)
  48:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 31c:	f7 f1                	div    %ecx
 31e:	8a 92 30 06 00 00    	mov    0x630(%edx),%dl
 ...
 37c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
{
 ...
 48c:	e9 02 ff ff ff       	jmp    393 <printf+0x2f>
        ...
        if(s == 0)
          s = "(null)";
 491:	be 29 06 00 00       	mov    $0x629,%esi
...
free(void *ap)
{
 ...
 4a4:	a1 e8 08 00 00       	mov    0x8e8,%eax
...
free(void *ap)
{
 ...
 4df:	89 08                	mov    %ecx,(%eax)
  freep = p;
 4e1:	a3 e8 08 00 00       	mov    %eax,0x8e8
}
 4e6:	5b                   	pop    %ebx
 4e7:	5e                   	pop    %esi
 4e8:	5f                   	pop    %edi
 ...
 50b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 50d:	a3 e8 08 00 00       	mov    %eax,0x8e8
}
 512:	5b                   	pop    %ebx
 513:	5e                   	pop    %esi
 514:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 52a:	43                   	inc    %ebx
  if((prevp = freep) == 0){
 52b:	8b 0d e8 08 00 00    	mov    0x8e8,%ecx
 ...
 555:	76 51                	jbe    5a8 <malloc+0x90>
    ...
    if(p == freep)
 557:	3b 05 e8 08 00 00    	cmp    0x8e8,%eax
...
morecore(uint nu)
{
 ...
 581:	e8 12 ff ff ff       	call   498 <free>
  return freep;
 586:	8b 0d e8 08 00 00    	mov    0x8e8,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
...
morecore(uint nu)
{
 ...
 5b4:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 5b7:	89 0d e8 08 00 00    	mov    %ecx,0x8e8
      return (void*)(p + 1);
 ...
 5cc:	eb e9                	jmp    5b7 <malloc+0x9f>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 5ce:	c7 05 e8 08 00 00 ec 	movl   $0x8ec,0x8e8
 5d5:	08 00 00 
 5d8:	c7 05 ec 08 00 00 ec 	movl   $0x8ec,0x8ec
 5df:	08 00 00 
    base.s.size = 0;
 5e2:	c7 05 f0 08 00 00 00 	movl   $0x0,0x8f0
 5e9:	00 00 00 
 5ec:	b8 ec 08 00 00       	mov    $0x8ec,%eax
