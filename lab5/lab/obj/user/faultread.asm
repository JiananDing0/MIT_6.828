	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800235:	0f be 80 48 1f 80 00 	movsbl 0x801f48(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003ed:	c7 44 24 08 60 1f 80 	movl   $0x801f60,0x8(%esp)
  8003f4:	00 
  ...
  800444:	75 05                	jne    80044b <vprintfmt+0x185>
				p = "(null)";
  800446:	be 59 1f 80 00       	mov    $0x801f59,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800abe:	00 
  800abf:	c7 44 24 08 3f 22 80 	movl   $0x80223f,0x8(%esp)
  800ac6:	00 
  800ac7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ace:	00 
  800acf:	c7 04 24 5c 22 80 00 	movl   $0x80225c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b50:	00 
  800b51:	c7 44 24 08 3f 22 80 	movl   $0x80223f,0x8(%esp)
  800b58:	00 
  800b59:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b60:	00 
  800b61:	c7 04 24 5c 22 80 00 	movl   $0x80225c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800ba3:	00 
  800ba4:	c7 44 24 08 3f 22 80 	movl   $0x80223f,0x8(%esp)
  800bab:	00 
  800bac:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bb3:	00 
  800bb4:	c7 04 24 5c 22 80 00 	movl   $0x80225c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bf6:	00 
  800bf7:	c7 44 24 08 3f 22 80 	movl   $0x80223f,0x8(%esp)
  800bfe:	00 
  800bff:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c06:	00 
  800c07:	c7 04 24 5c 22 80 00 	movl   $0x80225c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c49:	00 
  800c4a:	c7 44 24 08 3f 22 80 	movl   $0x80223f,0x8(%esp)
  800c51:	00 
  800c52:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c59:	00 
  800c5a:	c7 04 24 5c 22 80 00 	movl   $0x80225c,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c9c:	00 
  800c9d:	c7 44 24 08 3f 22 80 	movl   $0x80223f,0x8(%esp)
  800ca4:	00 
  800ca5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cac:	00 
  800cad:	c7 04 24 5c 22 80 00 	movl   $0x80225c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cef:	00 
  800cf0:	c7 44 24 08 3f 22 80 	movl   $0x80223f,0x8(%esp)
  800cf7:	00 
  800cf8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cff:	00 
  800d00:	c7 04 24 5c 22 80 00 	movl   $0x80225c,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800d64:	00 
  800d65:	c7 44 24 08 3f 22 80 	movl   $0x80223f,0x8(%esp)
  800d6c:	00 
  800d6d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d74:	00 
  800d75:	c7 04 24 5c 22 80 00 	movl   $0x80225c,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
  800e81:	42                   	inc    %edx
  800e82:	8b 04 95 e8 22 80 00 	mov    0x8022e8(,%edx,4),%eax
  ...
  800e9d:	c7 04 24 6c 22 80 00 	movl   $0x80226c,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8010f9:	c7 04 24 ad 22 80 00 	movl   $0x8022ad,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8011cf:	c7 04 24 c9 22 80 00 	movl   $0x8022c9,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801286:	c7 04 24 8c 22 80 00 	movl   $0x80228c,(%esp)
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  80148a:	83 ec 18             	sub    $0x18,%esp
	...
	panic("devfile_write not implemented");
  80148d:	c7 44 24 08 f8 22 80 	movl   $0x8022f8,0x8(%esp)
  801494:	00 
  801495:	c7 44 24 04 90 00 00 	movl   $0x90,0x4(%esp)
  80149c:	00 
  80149d:	c7 04 24 16 23 80 00 	movl   $0x802316,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8014de:	c7 44 24 0c 21 23 80 	movl   $0x802321,0xc(%esp)
  8014e5:	00 
  8014e6:	c7 44 24 08 28 23 80 	movl   $0x802328,0x8(%esp)
  8014ed:	00 
  8014ee:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  8014f5:	00 
  8014f6:	c7 04 24 16 23 80 00 	movl   $0x802316,(%esp)
  8014fd:	e8 02 06 00 00       	call   801b04 <_panic>
	assert(r <= PGSIZE);
  801502:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801507:	7e 24                	jle    80152d <devfile_read+0x84>
  801509:	c7 44 24 0c 3d 23 80 	movl   $0x80233d,0xc(%esp)
  801510:	00 
  801511:	c7 44 24 08 28 23 80 	movl   $0x802328,0x8(%esp)
  801518:	00 
  801519:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  801520:	00 
  801521:	c7 04 24 16 23 80 00 	movl   $0x802316,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801604:	c7 44 24 04 49 23 80 	movl   $0x802349,0x4(%esp)
  80160b:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8016d7:	c7 04 24 50 23 80 00 	movl   $0x802350,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801974:	c7 44 24 04 68 23 80 	movl   $0x802368,0x4(%esp)
  80197b:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801b30:	c7 04 24 74 23 80 00 	movl   $0x802374,(%esp)
  ...
  801b46:	e8 b8 e5 ff ff       	call   800103 <vcprintf>
	cprintf("\n");
  801b4b:	c7 04 24 3c 1f 80 00 	movl   $0x801f3c,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c09:	c7 44 24 08 98 23 80 	movl   $0x802398,0x8(%esp)
  801c10:	00 
  801c11:	c7 44 24 04 4b 00 00 	movl   $0x4b,0x4(%esp)
  801c18:	00 
  801c19:	c7 04 24 a6 23 80 00 	movl   $0x8023a6,(%esp)
