...
umain(int argc, char **argv)
{
  ...
  800076:	c7 44 24 08 44 25 80 	movl   $0x802544,0x8(%esp)
  80007d:	00 
  80007e:	c7 44 24 04 09 00 00 	movl   $0x9,0x4(%esp)
  800085:	00 
  800086:	c7 04 24 5c 25 80 00 	movl   $0x80255c,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800130:	c7 04 24 78 25 80 00 	movl   $0x802578,(%esp)
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800485:	c7 44 24 08 b3 25 80 	movl   $0x8025b3,0x8(%esp)
  80048c:	00 
  ...
  8004dc:	75 05                	jne    8004e3 <vprintfmt+0x185>
				p = "(null)";
  8004de:	be ac 25 80 00       	mov    $0x8025ac,%esi
			if (width > 0 && padc != '-')
