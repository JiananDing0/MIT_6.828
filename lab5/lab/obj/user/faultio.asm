...
read_eflags(void)
{
  ...
  800041:	c7 04 24 20 1f 80 00 	movl   $0x801f20,(%esp)
...
outb(int port, uint8_t data)
{
  ...
  800055:	c7 04 24 2e 1f 80 00 	movl   $0x801f2e,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800245:	0f be 80 52 1f 80 00 	movsbl 0x801f52(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800360:	ff 24 95 a0 20 80 00 	jmp    *0x8020a0(,%edx,4)
  ...
  800420:	c7 44 24 08 5a 23 80 	movl   $0x80235a,0x8(%esp)
  800427:	00 
  ...
  800454:	75 05                	jne    80045b <vprintfmt+0x185>
				p = "(null)";
  800456:	be 63 1f 80 00       	mov    $0x801f63,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800ace:	00 
  800acf:	c7 44 24 08 5f 22 80 	movl   $0x80225f,0x8(%esp)
  800ad6:	00 
  800ad7:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ade:	00 
  800adf:	c7 04 24 7c 22 80 00 	movl   $0x80227c,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b60:	00 
  800b61:	c7 44 24 08 5f 22 80 	movl   $0x80225f,0x8(%esp)
  800b68:	00 
  800b69:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b70:	00 
  800b71:	c7 04 24 7c 22 80 00 	movl   $0x80227c,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bb3:	00 
  800bb4:	c7 44 24 08 5f 22 80 	movl   $0x80225f,0x8(%esp)
  800bbb:	00 
  800bbc:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bc3:	00 
  800bc4:	c7 04 24 7c 22 80 00 	movl   $0x80227c,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c06:	00 
  800c07:	c7 44 24 08 5f 22 80 	movl   $0x80225f,0x8(%esp)
  800c0e:	00 
  800c0f:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c16:	00 
  800c17:	c7 04 24 7c 22 80 00 	movl   $0x80227c,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c59:	00 
  800c5a:	c7 44 24 08 5f 22 80 	movl   $0x80225f,0x8(%esp)
  800c61:	00 
  800c62:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c69:	00 
  800c6a:	c7 04 24 7c 22 80 00 	movl   $0x80227c,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800cac:	00 
  800cad:	c7 44 24 08 5f 22 80 	movl   $0x80225f,0x8(%esp)
  800cb4:	00 
  800cb5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cbc:	00 
  800cbd:	c7 04 24 7c 22 80 00 	movl   $0x80227c,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cff:	00 
  800d00:	c7 44 24 08 5f 22 80 	movl   $0x80225f,0x8(%esp)
  800d07:	00 
  800d08:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d0f:	00 
  800d10:	c7 04 24 7c 22 80 00 	movl   $0x80227c,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800d74:	00 
  800d75:	c7 44 24 08 5f 22 80 	movl   $0x80225f,0x8(%esp)
  800d7c:	00 
  800d7d:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d84:	00 
  800d85:	c7 04 24 7c 22 80 00 	movl   $0x80227c,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
	...
	for (i = 0; devtab[i]; i++)
  800e91:	42                   	inc    %edx
  800e92:	8b 04 95 08 23 80 00 	mov    0x802308(,%edx,4),%eax
  ...
  800ead:	c7 04 24 8c 22 80 00 	movl   $0x80228c,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801109:	c7 04 24 cd 22 80 00 	movl   $0x8022cd,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8011df:	c7 04 24 e9 22 80 00 	movl   $0x8022e9,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801296:	c7 04 24 ac 22 80 00 	movl   $0x8022ac,(%esp)
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  80149a:	83 ec 18             	sub    $0x18,%esp
	...
	panic("devfile_write not implemented");
  80149d:	c7 44 24 08 18 23 80 	movl   $0x802318,0x8(%esp)
  8014a4:	00 
  8014a5:	c7 44 24 04 90 00 00 	movl   $0x90,0x4(%esp)
  8014ac:	00 
  8014ad:	c7 04 24 36 23 80 00 	movl   $0x802336,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8014ee:	c7 44 24 0c 41 23 80 	movl   $0x802341,0xc(%esp)
  8014f5:	00 
  8014f6:	c7 44 24 08 48 23 80 	movl   $0x802348,0x8(%esp)
  8014fd:	00 
  8014fe:	c7 44 24 04 7c 00 00 	movl   $0x7c,0x4(%esp)
  801505:	00 
  801506:	c7 04 24 36 23 80 00 	movl   $0x802336,(%esp)
  80150d:	e8 02 06 00 00       	call   801b14 <_panic>
	assert(r <= PGSIZE);
  801512:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801517:	7e 24                	jle    80153d <devfile_read+0x84>
  801519:	c7 44 24 0c 5d 23 80 	movl   $0x80235d,0xc(%esp)
  801520:	00 
  801521:	c7 44 24 08 48 23 80 	movl   $0x802348,0x8(%esp)
  801528:	00 
  801529:	c7 44 24 04 7d 00 00 	movl   $0x7d,0x4(%esp)
  801530:	00 
  801531:	c7 04 24 36 23 80 00 	movl   $0x802336,(%esp)
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801614:	c7 44 24 04 69 23 80 	movl   $0x802369,0x4(%esp)
  80161b:	00 
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8016e7:	c7 04 24 70 23 80 00 	movl   $0x802370,(%esp)
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801984:	c7 44 24 04 88 23 80 	movl   $0x802388,0x4(%esp)
  80198b:	00 
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801b40:	c7 04 24 94 23 80 00 	movl   $0x802394,(%esp)
  ...
  801b56:	e8 b8 e5 ff ff       	call   800113 <vcprintf>
	cprintf("\n");
  801b5b:	c7 04 24 81 23 80 00 	movl   $0x802381,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801c19:	c7 44 24 08 b8 23 80 	movl   $0x8023b8,0x8(%esp)
  801c20:	00 
  801c21:	c7 44 24 04 4b 00 00 	movl   $0x4b,0x4(%esp)
  801c28:	00 
  801c29:	c7 04 24 c6 23 80 00 	movl   $0x8023c6,(%esp)
